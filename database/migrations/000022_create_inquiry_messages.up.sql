CREATE TABLE IF NOT EXISTS inquiry_messages (
    ...
    CONSTRAINT inquiry_messages_inquiry_id_stream_sequence_unique UNIQUE (inquiry_id, stream_sequence)
);
...
COMMENT ON COLUMN inquiry_messages.stream_sequence IS '問い合わせ内の位置（1 起算）';
