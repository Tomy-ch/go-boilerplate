...
- **`Meta` never carries an HTTP status.** The status is resolved solely from the sentinel classification; to change the status, change the sentinel. This keeps the decision of [ADR-0040](../../docs/adr/0039-apperror-protocol-agnostic-errors.md) intact (see [ADR-0041](../../docs/adr/0040-error-metadata-code-message-details.md)).
