...
This document explains how the repository's agent environment turns its declared properties into daily practice. It is an interpretation of [ADR-0008](../adr/0008-agent-environment-alignment.md), not a checklist or a second source of rules.
