...
# ADR-0040: SQS adapter is opt-in and not linked into the default binary
...
The worker scaffold ([ADR-0038](0038-broker-agnostic-worker-scaffold.md)) ships a reference
...
- Parent decision: [ADR-0038](0038-broker-agnostic-worker-scaffold.md). Principle: [ADR-0001](0001-avoid-lock-in.md).
