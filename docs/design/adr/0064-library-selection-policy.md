...
# ADR-0064: Single-responsibility library selection policy
...
exceptions (see [ADR-0065](0065-bridge-instrumentation-exceptions.md)).
...
- Parent principle: [ADR-0001](0001-avoid-lock-in.md). Exceptions: [ADR-0065](0065-bridge-instrumentation-exceptions.md).
