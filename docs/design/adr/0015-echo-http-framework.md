...
# ADR-0015: Adopt Echo as the HTTP framework
...
- The middleware chain design (priority-ordered, data-driven) and the HTTP-stack layering are recorded separately (see the HTTP-layer ADRs in [`../adr-migration-plan.md`](../adr-migration-plan.md)).
