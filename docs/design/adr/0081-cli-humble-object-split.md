...
# ADR-0081: CLI humble-object split (thin cmd/ shell + testable internal/cli core)
...
with the single-binary decision (see [ADR-0082](0082-single-multi-command-binary.md)).
