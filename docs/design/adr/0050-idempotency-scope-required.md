...
# ADR-0050: Every Store call requires an explicit scope to prevent cross-user key collisions
...
- Source: [`docs/design/idempotency.md`](../idempotency.md) §1 (design principles, "Scope
