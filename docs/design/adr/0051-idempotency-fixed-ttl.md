...
# ADR-0051: Fix idempotency key TTL at 24 hours with no per-route configuration
...
- Source: [`docs/design/idempotency.md`](../idempotency.md) §4 (operational notes, "TTL =
...
- Related ADR-0053 (idempotency GC as a separate job) relies on this fixed TTL to keep
