...
# ADR-0039: Push-type brokers and streaming-log platforms are out of scope for the worker port
...
The broker-agnostic worker scaffold ([ADR-0038](0038-broker-agnostic-worker-scaffold.md))
...
- Related: [ADR-0038](0038-broker-agnostic-worker-scaffold.md) (pull-ack worker scaffold,
