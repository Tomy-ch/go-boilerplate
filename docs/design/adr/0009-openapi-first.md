...
- The spec build pipeline (Redocly modular split → bundle → generate) and per-tag generation are recorded separately (see the API-contract ADRs in [`../adr-migration-plan.md`](../adr-migration-plan.md)).
