...
# ADR-0049: Run claim, business function, and complete in a single transaction for at-most-once semantics
...
- Source: [`docs/design/idempotency.md`](../idempotency.md) §1 (design principles) and §2.2
