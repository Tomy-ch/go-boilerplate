...
# ADR-0074: CI boots the real fx graph against real Postgres (startup verification)
...
- Related: [ADR-0030](0030-uber-fx-di.md) — the Uber fx DI container whose graph this
  check exercises.
- Related: [ADR-0038](0038-broker-agnostic-worker-scaffold.md) — the worker subsystem
