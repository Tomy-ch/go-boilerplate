...
# ADR-0054: Keep idempotency orthogonal to optimistic locking and rate limiting
...
- Source: [`docs/design/idempotency.md`](../idempotency.md) §1 ("orthogonal to optimistic
