...
# ADR-0034: Governance: default-in-code (immutable) vs required-in-file (variable)
...
[ADR-0035](0035-immutable-fail-fast-config.md)).
...
- Fail-fast startup behavior: [ADR-0035](0035-immutable-fail-fast-config.md).
