...
# ADR-0052: Persist the response body as JSON to enable deterministic replay (accepted PII tradeoff)
...
- Source: [`docs/design/idempotency.md`](../idempotency.md) §4 (operational notes, "PII
  caveat").
