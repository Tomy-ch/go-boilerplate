...
# ADR-0020: Generate type-safe SQL access with sqlc
...
Given the SQL-first stance ([ADR-0019](0019-sql-first-data-access.md)), the handwritten SQL
...
- Builds on [ADR-0019](0019-sql-first-data-access.md) (SQL-first).
