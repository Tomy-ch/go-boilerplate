...
# ADR-0060: Use only official OpenTelemetry semantic conventions; do not invent custom semconv or put vendor keys in typed config
...
[ADR-0059](0059-vendor-neutral-otlp-export.md). Vendor enrichment belongs in the
Collector pipeline.
...
- Complements: [ADR-0059](0059-vendor-neutral-otlp-export.md) (vendor-neutral export).
- Parent gating: [ADR-0058](0058-config-driven-observability-gating.md).
