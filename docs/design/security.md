...
golangci gate ([ADR-0088 (two-layer-golangci-config)](../adr/0088-two-layer-golangci-config.md)).
...
- [ADR-0088 (two-layer-golangci-config)](../adr/0088-two-layer-golangci-config.md) — `gosec` as an in-process check during static analysis
