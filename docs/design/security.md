...
[ADR-0085](../adr/0085-multi-layer-security-scanning.md), and reduces to this: a vulnerability
...
`.github/actions-pin.toml` ([ADR-0086](../adr/0086-sha-pinned-actions.md)) and
...
([ADR-0076](../adr/0076-mise-ssot-drift-gate.md); `python/README.md` has the mechanics). Installs
...
([ADR-0100](../adr/0100-no-in-app-rate-limiter.md)), and responses are not validated against the
...
golangci gate ([ADR-0080](../adr/0080-two-layer-golangci-config.md)).
...
- [ADR-0085](../adr/0085-multi-layer-security-scanning.md) — layered scanning, reporting/gating split, runner hardening
- [ADR-0086](../adr/0086-sha-pinned-actions.md) — SHA-pinned Actions and the supply-chain quarantine
- [ADR-0097](../adr/0097-release-image-supply-chain.md) — release-image integrity (signing, provenance, SBOM)
- [ADR-0080](../adr/0080-two-layer-golangci-config.md) — `gosec` as an in-process check during static analysis
