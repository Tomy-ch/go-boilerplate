...
[ADR-0087 (multi-layer-security-scanning)](../adr/0087-multi-layer-security-scanning.md), and reduces to this: a vulnerability
...
`.github/actions-pin.toml` ([ADR-0088 (sha-pinned-actions)](../adr/0088-sha-pinned-actions.md)) and
...
([ADR-0078 (mise-ssot-drift-gate)](../adr/0078-mise-ssot-drift-gate.md); `python/README.md` has the mechanics). Installs
...
(`internal/observability/http_client_transport.go`, [ADR-0023 (egress-ssrf-guard)](../adr/0023-egress-ssrf-guard.md))
...
([ADR-0102 (no-in-app-rate-limiter)](../adr/0102-no-in-app-rate-limiter.md)), and responses are not validated against the
...
([ADR-0025 (sqlc-type-safe-sql)](../adr/0025-sqlc-type-safe-sql.md)) — and `gosec` runs in the authoritative
golangci gate ([ADR-0082 (two-layer-golangci-config)](../adr/0082-two-layer-golangci-config.md)).
...
- [ADR-0087 (multi-layer-security-scanning)](../adr/0087-multi-layer-security-scanning.md) — layered scanning, reporting/gating split, runner hardening
- [ADR-0088 (sha-pinned-actions)](../adr/0088-sha-pinned-actions.md) — SHA-pinned Actions and the supply-chain quarantine
- [ADR-0099 (release-image-supply-chain)](../adr/0099-release-image-supply-chain.md) — release-image integrity (signing, provenance, SBOM)
- [ADR-0082 (two-layer-golangci-config)](../adr/0082-two-layer-golangci-config.md) — `gosec` as an in-process check during static analysis
