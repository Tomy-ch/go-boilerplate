...
書かれています。[ADR-0007 (agents-md-operational-contract)](adr/0007-agents-md-operational-contract.ja.md) を参照してください。
...
|[tutorial/](tutorial/build-user-feature.ja.md)|実例 — 1 つの機能を端から端まで作る <!-- sample-api:line -->|
...
flowchart TB
    ...
    %% = A["get-started/"] --> B["architecture.ja.md"] --> C["development-flow.ja.md"] --> D["rules.ja.md"] --> E["adr/"]
...
スキーマ、通常の CI 検査が AI サービスへ依存することはありません。[architecture.ja.md](architecture.ja.md)
§ *AI支援開発* を参照してください。
