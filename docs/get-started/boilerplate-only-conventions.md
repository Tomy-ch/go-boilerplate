...
[ADR-0027](../adr/0027-lightweight-cqrs.md)'s CommandService section describing an intended design
...
[ADR-0077](../adr/0077-scripts-in-node-go.md) states the general form: every script keeps its
