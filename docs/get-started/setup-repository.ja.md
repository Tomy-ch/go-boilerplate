...
[English](setup-repository.md) | 日本語
...
4. [.github/workflows/README.md](../../.github/workflows/README.md) のトリガーマトリクスと [ADR-0088](../adr/0088-multi-layer-security-scanning.md) のライセンス行を更新する（いずれも現状「方針なし」と記載しています）。
