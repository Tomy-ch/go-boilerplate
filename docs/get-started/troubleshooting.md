...
足りません。有効化手順と確認方法は [setup-repository.md](setup-repository.md) の Phase 1 です。
...
[setup-repository.md](setup-repository.md) の Phase 11、設計は
[auth.md](../design/auth.md) にあります。
...
なぜその番号なのかは [local-environment.md](../maintenance/local-environment.md)。複数 worktree を
...
[local-environment.md](../maintenance/local-environment.md) にあります。
...
- [setup-repository.md](setup-repository.md) — このページが前提とする段階的セットアップ
- [local-environment.md](../maintenance/local-environment.md) — コンテナ・ポート・tool-runner
- [db-worktree-pool.md](../maintenance/db-worktree-pool.md) — 共有データベースに対する複数 worktree の運用
- [.makefiles/README.md](../../.makefiles/README.md) — 領域別の全ターゲット
