...
4. Update the trigger matrix in [.github/workflows/README.md](../../.github/workflows/README.md) and the license row of [ADR-0088 (multi-layer-security-scanning)](../adr/0088-multi-layer-security-scanning.md), which both currently state that no policy exists.
