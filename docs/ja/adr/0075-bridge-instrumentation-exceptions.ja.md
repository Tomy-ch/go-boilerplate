...
# ADR-0075: ブリッジ / 計装ライブラリを有界な SRP 例外として認める

English canonical: [0075-bridge-instrumentation-exceptions.md](../../adr/0075-bridge-instrumentation-exceptions.md)
...
ライブラリ選定ポリシー（[ADR-0074](0074-library-selection-policy.ja.md)）は、責任が単一の
...
- otel-contrib 系（`otelhttp` / `otelzap`）は**otel-contrib の月次リリーストレイン**で
  ...
  （`github.com/labstack/echo-opentelemetry`、MIT — [ADR-0019](0019-echo-http-framework.ja.md) を参照）、
