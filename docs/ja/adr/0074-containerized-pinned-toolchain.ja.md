...
# ADR-0074: 再現性のために mise でバージョン固定されたコンテナ化ツールチェーンを使用する

English canonical: [0074-containerized-pinned-toolchain.md](../../adr/0074-containerized-pinned-toolchain.md)
...
`python/*.in` と `python/*.txt`。[ADR-0075](0075-mise-ssot-drift-gate.ja.md)）、Docker イメージに
焼き込まれる。
