...
# ADR-0051: トランザクショナルアウトボックス — ビジネストランザクション内でイベントを発行する

English canonical: [0051-transactional-outbox.md](../../adr/0051-transactional-outbox.md)
...
- 関連 ADR: [ADR-0052](0052-at-least-once-outbox-poll.ja.md)（デリバリー保証）、[ADR-0053](0053-skip-locked-outbox-relay.ja.md)（リレー並行性）。
