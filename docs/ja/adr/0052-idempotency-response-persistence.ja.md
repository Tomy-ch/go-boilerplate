...
# ADR-0052: 決定論的リプレイを可能にするためレスポンスボディを JSON で永続化する（PII トレードオフを許容）

English canonical: [0052-idempotency-response-persistence.md](../../adr/0052-idempotency-response-persistence.md)
