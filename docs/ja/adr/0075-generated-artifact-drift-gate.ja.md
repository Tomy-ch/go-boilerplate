...
# ADR-0075: 生成成果物ドリフトゲートとリリースブランチ集約型自動生成ボット

English canonical: [0075-generated-artifact-drift-gate.md](../../adr/0075-generated-artifact-drift-gate.md)
...
- 関連: [ADR-0020](0020-sqlc-type-safe-sql.ja.md) — DB 成果物生成のソースである sqlc。
