...
# ADR-0041: 設定は不変、起動時に 1 回だけロード、フェイルファスト

English canonical: [0041-immutable-fail-fast-config.md](../../adr/0041-immutable-fail-fast-config.md)
...
- デフォルト対必須のガバナンス: [ADR-0040](0040-config-default-vs-required-governance.ja.md)。
- 埋め込み env ファイルの仕組み: [ADR-0042](0042-embedded-self-contained-binary.ja.md)。
