...
# ADR-0050: トランザクショナルアウトボックス — ビジネストランザクション内でイベントを発行する

English canonical: [0050-transactional-outbox.md](../../adr/0050-transactional-outbox.md)
...
- 関連 ADR: [ADR-0051](0051-at-least-once-outbox-poll.ja.md)（デリバリー保証）、[ADR-0052](0052-skip-locked-outbox-relay.ja.md)（リレー並行性）。
