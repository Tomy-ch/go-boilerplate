...
# ADR-0055: 発行済み行の 7 日間保持 GC（10,000 件単位のバッチ）

English canonical: [0055-outbox-retention-gc.md](../../adr/0055-outbox-retention-gc.md)
...
- 関連 ADR: [ADR-0054](0054-outbox-dead-after-max-attempts.ja.md)、[ADR-0057](0057-relay-resident-gc-oneshot.ja.md)。
