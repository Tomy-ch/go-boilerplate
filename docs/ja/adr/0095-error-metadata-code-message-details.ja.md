...
# ADR-0095: apperror の上に載せるプロトコル中立なエラーメタ情報（code / message / details）

English canonical: [0095-error-metadata-code-message-details.md](../../adr/0095-error-metadata-code-message-details.md)
...
[ADR-0038](0038-apperror-protocol-agnostic-errors.ja.md) はプロトコル非依存のエラー taxonomy を
...
`Meta` に HTTP ステータスの上書きを許す。棄却: ADR-0038 が取り除いた結合を再導入し、
