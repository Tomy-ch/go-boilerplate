...
# ADR-0042: 設定は不変、起動時に 1 回だけロード、フェイルファスト

English canonical: [0042-immutable-fail-fast-config.md](../../adr/0042-immutable-fail-fast-config.md)
...
- デフォルト対必須のガバナンス: [ADR-0041](0041-config-default-vs-required-governance.ja.md)。
- 埋め込み env ファイルの仕組み: [ADR-0043](0043-embedded-self-contained-binary.ja.md)。
