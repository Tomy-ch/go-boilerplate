...
# ADR-0044: SELECT FOR UPDATE SKIP LOCKED を使った単一トランザクションリレー（複数インスタンス間で安全）

English canonical: [0044-skip-locked-outbox-relay.md](../../adr/0044-skip-locked-outbox-relay.md)
