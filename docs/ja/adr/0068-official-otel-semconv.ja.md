...
# ADR-0068: 公式 OpenTelemetry セマンティック規約のみを使用し、カスタム semconv の発明や型付き設定へのベンダーキー追加は行わない

English canonical: [0068-official-otel-semconv.md](../../adr/0068-official-otel-semconv.md)
...
結合が生まれ、[ADR-0067](0067-vendor-neutral-otlp-export.ja.md) のベンダー中立の立場が
...
- 補完する決定: [ADR-0067](0067-vendor-neutral-otlp-export.ja.md)（ベンダー中立エクスポート）。
- 親ゲーティング: [ADR-0066](0066-config-driven-observability-gating.ja.md)。
