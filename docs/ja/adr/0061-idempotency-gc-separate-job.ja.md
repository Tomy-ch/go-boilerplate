...
# ADR-0061: 冪等性キーのガベージコレクションを独立したワンショット CLI ジョブとして実行する

English canonical: [0061-idempotency-gc-separate-job.md](../../adr/0061-idempotency-gc-separate-job.md)
...
- 関連: [ADR-0059](0059-idempotency-fixed-ttl.ja.md)（GC がスイープ対象とする 24 時間固定 TTL）。
