...
# ADR-0037: ニュートラルな DI 抽象（Registrar / Shutdowner）の背後に fx を封じ込める

English canonical: [0037-fx-neutral-di-abstraction.md](../../adr/0037-fx-neutral-di-abstraction.md)
...
[ADR-0036](0036-uber-fx-di.ja.md) は DI およびライフサイクルコンテナとして Uber Fx を採用している。
...
- 親となる決定: [ADR-0036](0036-uber-fx-di.ja.md)（Uber Fx の採用）。
