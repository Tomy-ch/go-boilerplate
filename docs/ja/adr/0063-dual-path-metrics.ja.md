...
# ADR-0063: メトリクスは 2 経路を通る — OTLP プッシュと Prometheus スクレイプ

English canonical: [0063-dual-path-metrics.md](../../adr/0063-dual-path-metrics.md)
...
- 親: [ADR-0060](0060-config-driven-observability-gating.ja.md)（設定駆動ゲーティング）。
