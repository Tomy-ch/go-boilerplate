...
# ADR-0056: 発行済み行の 7 日間保持 GC（10,000 件単位のバッチ）

English canonical: [0056-outbox-retention-gc.md](../../adr/0056-outbox-retention-gc.md)
...
- 関連 ADR: [ADR-0055](0055-outbox-dead-after-max-attempts.ja.md)、[ADR-0058](0058-relay-resident-gc-oneshot.ja.md)。
