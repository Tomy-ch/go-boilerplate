...
# ADR-0062: オブザーバビリティプロバイダーはライフサイクル非依存（ProviderShutdowner）

English canonical: [0062-lifecycle-independent-provider.md](../../adr/0062-lifecycle-independent-provider.md)
