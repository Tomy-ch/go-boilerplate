...
# ADR-0028: CQRSの分割の外に位置する第4のDMLカテゴリとしてsystem_cqrsを導入する

English canonical: [0028-system-cqrs-dml-category.md](../../adr/0028-system-cqrs-dml-category.md)
...
`system_cqrs`カテゴリは[ADR-0027](0027-lightweight-cqrs.ja.md)で説明したCQRSの読み込み/書き込み分割の明示的な外側に位置する。アプリケーションのビジネスロジックではなくインフラの関心事に対応する。
