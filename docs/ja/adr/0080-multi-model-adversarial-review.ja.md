...
# ADR-0080: ファインダー・ベリファイアーサブエージェントによるマルチモデル敵対的レビューを使用する

English canonical: [0080-multi-model-adversarial-review.md](../../adr/0080-multi-model-adversarial-review.md)
