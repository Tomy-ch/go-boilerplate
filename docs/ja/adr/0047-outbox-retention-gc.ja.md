...
# ADR-0047: 発行済み行の 7 日間保持 GC（10,000 件単位のバッチ）

English canonical: [0047-outbox-retention-gc.md](../../adr/0047-outbox-retention-gc.md)
...
- 関連 ADR: [ADR-0046](0046-outbox-dead-after-max-attempts.ja.md)、[ADR-0049](0049-relay-resident-gc-oneshot.ja.md)。
