...
# ADR-0072: オブザーバビリティプロバイダーはライフサイクル非依存（ProviderShutdowner）

English canonical: [0072-lifecycle-independent-provider.md](../../adr/0072-lifecycle-independent-provider.md)
...
- 親: [ADR-0068](0068-config-driven-observability-gating.ja.md)。
