...
# ADR-0016: /metrics は認証例外 — OpenAPI 検証の外に置き、独立した BasicAuth ミドルウェアで保護する

English canonical: [0016-metrics-endpoint-auth-exception.md](../../adr/0016-metrics-endpoint-auth-exception.md)
