...
# ADR-0049: トランザクショナルアウトボックス — ビジネストランザクション内でイベントを発行する

English canonical: [0049-transactional-outbox.md](../../adr/0049-transactional-outbox.md)
...
- 関連 ADR: [ADR-0050](0050-at-least-once-outbox-poll.ja.md)（デリバリー保証）、[ADR-0051](0051-skip-locked-outbox-relay.ja.md)（リレー並行性）。
