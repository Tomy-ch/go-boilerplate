...
# ADR-0059: Job は明示的に登録する（自動検出なし）

English canonical: [0059-job-explicit-registration.md](../../adr/0059-job-explicit-registration.md)
...
本リポジトリは依存性注入に Uber Fx を使用しており（[ADR-0031](0031-uber-fx-di.ja.md) 参照）、
