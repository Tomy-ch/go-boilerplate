...
# ADR-0021: アウトバウンドHTTPレジリエンス基盤の提供（リトライ / サーキットブレーカー / リトライバジェット / デュアルタイムアウト）

English canonical: [0021-outbound-http-resilience.md](../../adr/0021-outbound-http-resilience.md)
...
- トランスポート（インストルメンテーション + SSRFガード）: `internal/observability/http_client_transport.go` — [ADR-0022](0022-egress-ssrf-guard.ja.md)参照。
