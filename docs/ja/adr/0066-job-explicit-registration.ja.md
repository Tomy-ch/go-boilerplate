...
# ADR-0066: Job は明示的に登録する（自動検出なし）

English canonical: [0066-job-explicit-registration.md](../../adr/0066-job-explicit-registration.md)
...
本リポジトリは依存性注入に Uber Fx を使用しており（[ADR-0036](0036-uber-fx-di.ja.md) 参照）、
