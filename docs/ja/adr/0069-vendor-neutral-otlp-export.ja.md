...
# ADR-0069: ベンダー中立の OTLP 専用エクスポート（バックエンドは Collector に委譲）

English canonical: [0069-vendor-neutral-otlp-export.md](../../adr/0069-vendor-neutral-otlp-export.md)
...
この決定は [ADR-0068](0068-config-driven-observability-gating.ja.md) によってゲーティングされる。
...
生み出す。[ADR-0068](0068-config-driven-observability-gating.ja.md) がこの却下を詳述している。
...
- 設定駆動ゲーティング: [ADR-0068](0068-config-driven-observability-gating.ja.md)。
