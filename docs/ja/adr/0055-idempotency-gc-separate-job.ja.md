...
# ADR-0055: 冪等性キーのガベージコレクションを独立したワンショット CLI ジョブとして実行する

English canonical: [0055-idempotency-gc-separate-job.md](../../adr/0055-idempotency-gc-separate-job.md)
...
- 関連: [ADR-0053](0053-idempotency-fixed-ttl.ja.md)（GC がスイープ対象とする 24 時間固定 TTL）。
