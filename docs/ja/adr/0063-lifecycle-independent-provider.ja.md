...
# ADR-0063: オブザーバビリティプロバイダーはライフサイクル非依存（ProviderShutdowner）

English canonical: [0063-lifecycle-independent-provider.md](../../adr/0063-lifecycle-independent-provider.md)
...
- 親: [ADR-0059](0059-config-driven-observability-gating.ja.md)。
