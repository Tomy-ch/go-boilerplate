...
# ADR-0054: 発行済み行の 7 日間保持 GC（10,000 件単位のバッチ）

English canonical: [0054-outbox-retention-gc.md](../../adr/0054-outbox-retention-gc.md)
...
- 関連 ADR: [ADR-0053](0053-outbox-dead-after-max-attempts.ja.md)、[ADR-0056](0056-relay-resident-gc-oneshot.ja.md)。
