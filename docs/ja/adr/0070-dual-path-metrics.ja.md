...
# ADR-0070: メトリクスは 2 経路を通る — OTLP プッシュと Prometheus スクレイプ

English canonical: [0070-dual-path-metrics.md](../../adr/0070-dual-path-metrics.md)
...
- 親: [ADR-0067](0067-config-driven-observability-gating.ja.md)（設定駆動ゲーティング）。
