...
# ADR-0017: アウトバウンドHTTPレジリエンス基盤の提供（リトライ / サーキットブレーカー / リトライバジェット / デュアルタイムアウト）

English canonical: [0017-outbound-http-resilience.md](../../adr/0017-outbound-http-resilience.md)
...
- トランスポート（インストルメンテーション + SSRFガード）: `internal/observability/http_client_transport.go` — [ADR-0018](0018-egress-ssrf-guard.ja.md)参照。
