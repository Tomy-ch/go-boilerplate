...
# ADR-0071: 運用スクリプトは scripts/ に Node（.mjs）または Go で配置し、シェルスクリプトは使用しない

English canonical: [0071-scripts-in-node-go.md](../../adr/0071-scripts-in-node-go.md)
...
- スクリプトを呼び出す Make ターゲットエントリポイント:
  [ADR-0070](0070-make-single-entrypoint.ja.md)。
