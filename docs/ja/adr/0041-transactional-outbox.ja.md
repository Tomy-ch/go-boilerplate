...
# ADR-0041: トランザクショナルアウトボックス — ビジネストランザクション内でイベントを発行する

English canonical: [0041-transactional-outbox.md](../../adr/0041-transactional-outbox.md)
...
- 関連 ADR: [ADR-0042](0042-at-least-once-outbox-poll.ja.md)（デリバリー保証）、[ADR-0043](0043-skip-locked-outbox-relay.ja.md)（リレー並行性）。
