...
# ADR-0066: 単一責任のライブラリ選定ポリシー

English canonical: [0066-library-selection-policy.md](../../adr/0066-library-selection-policy.md)
...
（[ADR-0067](0067-bridge-instrumentation-exceptions.ja.md) 参照）。
...
- 親原則: [ADR-0001](0001-avoid-lock-in.ja.md)。例外: [ADR-0067](0067-bridge-instrumentation-exceptions.ja.md)。
