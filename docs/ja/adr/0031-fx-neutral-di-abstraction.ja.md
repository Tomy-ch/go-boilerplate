...
# ADR-0031: ニュートラルな DI 抽象（Registrar / Shutdowner）の背後に fx を封じ込める

English canonical: [0031-fx-neutral-di-abstraction.md](../../adr/0031-fx-neutral-di-abstraction.md)
...
[ADR-0030](0030-uber-fx-di.ja.md) は DI およびライフサイクルコンテナとして Uber Fx を採用している。
...
- 親となる決定: [ADR-0030](0030-uber-fx-di.ja.md)（Uber Fx の採用）。
