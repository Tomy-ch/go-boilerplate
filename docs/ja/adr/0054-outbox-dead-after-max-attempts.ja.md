...
# ADR-0054: MaxAttempts = 10 到達でメッセージをデッド状態にする（手動リプレイまで終端）

English canonical: [0054-outbox-dead-after-max-attempts.md](../../adr/0054-outbox-dead-after-max-attempts.md)
...
- 関連 ADR: [ADR-0051](0051-at-least-once-outbox-poll.ja.md)、[ADR-0055](0055-outbox-retention-gc.ja.md)。
