...
# ADR-0046: MaxAttempts = 10 到達でメッセージをデッド状態にする（手動リプレイまで終端）

English canonical: [0046-outbox-dead-after-max-attempts.md](../../adr/0046-outbox-dead-after-max-attempts.md)
...
- 関連 ADR: [ADR-0043](0043-at-least-once-outbox-poll.ja.md)、[ADR-0047](0047-outbox-retention-gc.ja.md)。
