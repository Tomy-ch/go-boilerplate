...
# ADR-0076: 再現性のために mise でバージョン固定されたコンテナ化ツールチェーンを使用する

English canonical: [0076-containerized-pinned-toolchain.md](../../adr/0076-containerized-pinned-toolchain.md)
...
`python/*.in` と `python/*.txt`。[ADR-0077](0077-mise-ssot-drift-gate.ja.md)）、Docker イメージに
焼き込まれる。
