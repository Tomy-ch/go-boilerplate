...
# ADR-0076: CI は実際の Postgres に対して実際の fx グラフを起動する（スタートアップ検証）

English canonical: [0076-ci-real-graph-boot-check.md](../../adr/0076-ci-real-graph-boot-check.md)
...
- 関連: [ADR-0040](0040-broker-agnostic-worker-scaffold.ja.md) — エントリポイントが検証されるワーカーサブシステム。
