...
# ADR-0067: ブリッジ / 計装ライブラリを有界な SRP 例外として認める

English canonical: [0067-bridge-instrumentation-exceptions.md](../../adr/0067-bridge-instrumentation-exceptions.md)
...
ライブラリ選定ポリシー（[ADR-0066](0066-library-selection-policy.ja.md)）は、責任が単一の
...
- 親ポリシー: [ADR-0066](0066-library-selection-policy.ja.md)。関連ゲーティング決定: [ADR-0060](0060-config-driven-observability-gating.ja.md)。
