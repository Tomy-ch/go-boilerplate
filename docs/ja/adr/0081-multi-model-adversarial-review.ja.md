...
# ADR-0081: ファインダー・ベリファイアーサブエージェントによるマルチモデル敵対的レビューを使用する

English canonical: [0081-multi-model-adversarial-review.md](../../adr/0081-multi-model-adversarial-review.md)
