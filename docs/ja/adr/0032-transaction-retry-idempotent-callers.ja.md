...
# ADR-0032: シリアライゼーション競合時はトランザクションをリトライする。呼び出し元は冪等性を保証しなければならない

English canonical: [0032-transaction-retry-idempotent-callers.md](../../adr/0032-transaction-retry-idempotent-callers.md)
