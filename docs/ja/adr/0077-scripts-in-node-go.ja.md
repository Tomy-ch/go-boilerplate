...
# ADR-0077: 運用スクリプトは scripts/ に Node（.mjs）または Go で配置し、シェルスクリプトは使用しない

English canonical: [0077-scripts-in-node-go.md](../../adr/0077-scripts-in-node-go.md)
...
- スクリプトを呼び出す Make ターゲットエントリポイント:
  [ADR-0076](0076-make-single-entrypoint.ja.md)。
