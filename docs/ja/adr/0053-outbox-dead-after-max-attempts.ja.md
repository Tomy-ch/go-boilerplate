...
# ADR-0053: MaxAttempts = 10 到達でメッセージをデッド状態にする（手動リプレイまで終端）

English canonical: [0053-outbox-dead-after-max-attempts.md](../../adr/0053-outbox-dead-after-max-attempts.md)
...
- 関連 ADR: [ADR-0050](0050-at-least-once-outbox-poll.ja.md)、[ADR-0054](0054-outbox-retention-gc.ja.md)。
