...
# ADR-0043: トランザクショナルアウトボックス — ビジネストランザクション内でイベントを発行する

English canonical: [0043-transactional-outbox.md](../../adr/0043-transactional-outbox.md)
...
- 関連 ADR: [ADR-0044](0044-at-least-once-outbox-poll.ja.md)（デリバリー保証）、[ADR-0045](0045-skip-locked-outbox-relay.ja.md)（リレー並行性）。
