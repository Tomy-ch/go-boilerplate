...
# ADR-0036: ニュートラルな DI 抽象（Registrar / Shutdowner）の背後に fx を封じ込める

English canonical: [0036-fx-neutral-di-abstraction.md](../../adr/0036-fx-neutral-di-abstraction.md)
...
[ADR-0035](0035-uber-fx-di.ja.md) は DI およびライフサイクルコンテナとして Uber Fx を採用している。
...
- 親となる決定: [ADR-0035](0035-uber-fx-di.ja.md)（Uber Fx の採用）。
