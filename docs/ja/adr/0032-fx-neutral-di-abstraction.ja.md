...
# ADR-0032: ニュートラルな DI 抽象（Registrar / Shutdowner）の背後に fx を封じ込める

English canonical: [0032-fx-neutral-di-abstraction.md](../../adr/0032-fx-neutral-di-abstraction.md)
...
[ADR-0031](0031-uber-fx-di.ja.md) は DI およびライフサイクルコンテナとして Uber Fx を採用している。
...
- 親となる決定: [ADR-0031](0031-uber-fx-di.ja.md)（Uber Fx の採用）。
