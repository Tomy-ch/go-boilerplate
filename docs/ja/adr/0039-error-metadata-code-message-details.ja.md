...
# ADR-0039: apperror の上に載せるプロトコル中立なエラーメタ情報（code / message / details）

English canonical: [0039-error-metadata-code-message-details.md](../../adr/0039-error-metadata-code-message-details.md)
