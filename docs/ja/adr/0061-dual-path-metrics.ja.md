...
# ADR-0061: メトリクスは 2 経路を通る — OTLP プッシュと Prometheus スクレイプ

English canonical: [0061-dual-path-metrics.md](../../adr/0061-dual-path-metrics.md)
...
- 親: [ADR-0058](0058-config-driven-observability-gating.ja.md)（設定駆動ゲーティング）。
