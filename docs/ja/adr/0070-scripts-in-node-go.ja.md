...
# ADR-0070: 運用スクリプトは scripts/ に Node（.mjs）または Go で配置し、シェルスクリプトは使用しない

English canonical: [0070-scripts-in-node-go.md](../../adr/0070-scripts-in-node-go.md)
...
- スクリプトを呼び出す Make ターゲットエントリポイント:
  [ADR-0069](0069-make-single-entrypoint.ja.md)。
