...
# ADR-0074: CI は実際の Postgres に対して実際の fx グラフを起動する（スタートアップ検証）

English canonical: [0074-ci-real-graph-boot-check.md](../../adr/0074-ci-real-graph-boot-check.md)
...
- 関連: [ADR-0030](0030-uber-fx-di.ja.md) — このチェックが実行する Uber fx DI コンテナのグラフ。
- 関連: [ADR-0038](0038-broker-agnostic-worker-scaffold.ja.md) — エントリポイントが検証されるワーカーサブシステム。
