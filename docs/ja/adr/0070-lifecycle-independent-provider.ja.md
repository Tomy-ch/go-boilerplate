...
# ADR-0070: オブザーバビリティプロバイダーはライフサイクル非依存（ProviderShutdowner）

English canonical: [0070-lifecycle-independent-provider.md](../../adr/0070-lifecycle-independent-provider.md)
...
- 親: [ADR-0066](0066-config-driven-observability-gating.ja.md)。
