...
# ADR-0030: シリアライゼーション競合時はトランザクションをリトライする。呼び出し元は冪等性を保証しなければならない

English canonical: [0030-transaction-retry-idempotent-callers.md](../../adr/0030-transaction-retry-idempotent-callers.md)
