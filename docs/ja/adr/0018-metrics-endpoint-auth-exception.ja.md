...
# ADR-0018: /metrics は認証例外 — OpenAPI 検証の外に置き、独立した BasicAuth ミドルウェアで保護する

English canonical: [0018-metrics-endpoint-auth-exception.md](../../adr/0018-metrics-endpoint-auth-exception.md)
...
- 関連する決定: [ADR-0015](0015-spec-driven-request-validation.ja.md)（仕様駆動リクエスト検証——この ADR はその付随する例外記録）。
