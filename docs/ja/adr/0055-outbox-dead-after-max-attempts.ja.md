...
# ADR-0055: MaxAttempts = 10 到達でメッセージをデッド状態にする（手動リプレイまで終端）

English canonical: [0055-outbox-dead-after-max-attempts.md](../../adr/0055-outbox-dead-after-max-attempts.md)
...
- 関連 ADR: [ADR-0052](0052-at-least-once-outbox-poll.ja.md)、[ADR-0056](0056-outbox-retention-gc.ja.md)。
