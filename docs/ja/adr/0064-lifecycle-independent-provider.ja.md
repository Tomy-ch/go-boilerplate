...
# ADR-0064: オブザーバビリティプロバイダーはライフサイクル非依存（ProviderShutdowner）

English canonical: [0064-lifecycle-independent-provider.md](../../adr/0064-lifecycle-independent-provider.md)
...
- 親: [ADR-0060](0060-config-driven-observability-gating.ja.md)。
