...
# ADR-0042: トランザクショナルアウトボックス — ビジネストランザクション内でイベントを発行する

English canonical: [0042-transactional-outbox.md](../../adr/0042-transactional-outbox.md)
...
- 関連 ADR: [ADR-0043](0043-at-least-once-outbox-poll.ja.md)（デリバリー保証）、[ADR-0044](0044-skip-locked-outbox-relay.ja.md)（リレー並行性）。
