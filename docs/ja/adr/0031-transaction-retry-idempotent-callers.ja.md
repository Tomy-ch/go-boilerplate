...
# ADR-0031: シリアライゼーション競合時はトランザクションをリトライする。呼び出し元は冪等性を保証しなければならない

English canonical: [0031-transaction-retry-idempotent-callers.md](../../adr/0031-transaction-retry-idempotent-callers.md)
