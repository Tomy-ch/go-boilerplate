...
# ADR-0025: マージされたDMLおよびダンプされたスキーマをsqlcの単一入力として使用する

English canonical: [0025-merged-dml-schema-as-sqlc-input.md](../../adr/0025-merged-dml-schema-as-sqlc-input.md)
...
- 関連: [ADR-0023](0023-sql-first-data-access.ja.md)（SQLファーストデータアクセス）、[ADR-0024](0024-sqlc-type-safe-sql.ja.md)（コードジェネレーターとしてのsqlc）。
