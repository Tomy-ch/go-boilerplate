...
# ADR-0080: ローカル開発環境はプロファイルで分離されたサービスを持つ Docker Compose で提供する

English canonical: [0080-docker-compose-dev-environment.md](../../adr/0080-docker-compose-dev-environment.md)
...
ツール実行はマシン間で再現可能でなければならない（[ADR-0076](0076-containerized-pinned-toolchain.ja.md) 参照）。
