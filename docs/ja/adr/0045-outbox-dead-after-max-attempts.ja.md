...
# ADR-0045: MaxAttempts = 10 到達でメッセージをデッド状態にする（手動リプレイまで終端）

English canonical: [0045-outbox-dead-after-max-attempts.md](../../adr/0045-outbox-dead-after-max-attempts.md)
...
- 関連 ADR: [ADR-0042](0042-at-least-once-outbox-poll.ja.md)、[ADR-0046](0046-outbox-retention-gc.ja.md)。
