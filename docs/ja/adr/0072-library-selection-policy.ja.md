...
# ADR-0072: 単一責任のライブラリ選定ポリシー

English canonical: [0072-library-selection-policy.md](../../adr/0072-library-selection-policy.md)
...
（[ADR-0073](0073-bridge-instrumentation-exceptions.ja.md) 参照）。
...
- 親原則: [ADR-0001](0001-avoid-lock-in.ja.md)。例外: [ADR-0073](0073-bridge-instrumentation-exceptions.ja.md)。
