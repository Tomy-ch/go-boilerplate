...
# ADR-0048: 発行済み行の 7 日間保持 GC（10,000 件単位のバッチ）

English canonical: [0048-outbox-retention-gc.md](../../adr/0048-outbox-retention-gc.md)
...
- 関連 ADR: [ADR-0047](0047-outbox-dead-after-max-attempts.ja.md)、[ADR-0050](0050-relay-resident-gc-oneshot.ja.md)。
