...
# ADR-0062: メトリクスは 2 経路を通る — OTLP プッシュと Prometheus スクレイプ

English canonical: [0062-dual-path-metrics.md](../../adr/0062-dual-path-metrics.md)
...
- 親: [ADR-0059](0059-config-driven-observability-gating.ja.md)（設定駆動ゲーティング）。
