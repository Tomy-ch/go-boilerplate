...
# ADR-0034: すべてのエンティティ主キーに UUIDv7（時刻順）識別子を使用する

English canonical: [0034-uuidv7-identifiers.md](../../adr/0034-uuidv7-identifiers.md)
...
- 関連: [ADR-0024](0024-sqlc-type-safe-sql.ja.md)（sqlc の型オーバーライドがこの UUID 型を生成コードに組み込む仕組み）。
