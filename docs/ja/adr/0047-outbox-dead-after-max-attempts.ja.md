...
# ADR-0047: MaxAttempts = 10 到達でメッセージをデッド状態にする（手動リプレイまで終端）

English canonical: [0047-outbox-dead-after-max-attempts.md](../../adr/0047-outbox-dead-after-max-attempts.md)
...
- 関連 ADR: [ADR-0044](0044-at-least-once-outbox-poll.ja.md)、[ADR-0048](0048-outbox-retention-gc.ja.md)。
