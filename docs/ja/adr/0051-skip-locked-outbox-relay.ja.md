...
# ADR-0051: SELECT FOR UPDATE SKIP LOCKED を使った単一トランザクションリレー（複数インスタンス間で安全）

English canonical: [0051-skip-locked-outbox-relay.md](../../adr/0051-skip-locked-outbox-relay.md)
