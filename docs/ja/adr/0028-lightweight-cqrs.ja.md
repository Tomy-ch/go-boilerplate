...
# ADR-0028: 軽量CQRSの採用 — 書き込みにRepository、読み込みにQueryService

English canonical: [0028-lightweight-cqrs.md](../../adr/0028-lightweight-cqrs.md)
...
- 関連: [ADR-0029](0029-system-cqrs-dml-category.ja.md)（CQRSの外に位置する第4カテゴリとしてのsystem_cqrs）。
