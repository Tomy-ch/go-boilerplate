...
# ADR-0036: 設定は不変、起動時に 1 回だけロード、フェイルファスト

English canonical: [0036-immutable-fail-fast-config.md](../../adr/0036-immutable-fail-fast-config.md)
...
- デフォルト対必須のガバナンス: [ADR-0035](0035-config-default-vs-required-governance.ja.md)。
- 埋め込み env ファイルの仕組み: [ADR-0037](0037-embedded-self-contained-binary.ja.md)。
