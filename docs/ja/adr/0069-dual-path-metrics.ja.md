...
# ADR-0069: メトリクスは 2 経路を通る — OTLP プッシュと Prometheus スクレイプ

English canonical: [0069-dual-path-metrics.md](../../adr/0069-dual-path-metrics.md)
...
- 親: [ADR-0066](0066-config-driven-observability-gating.ja.md)（設定駆動ゲーティング）。
