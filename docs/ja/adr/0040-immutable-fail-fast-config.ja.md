...
# ADR-0040: 設定は不変、起動時に 1 回だけロード、フェイルファスト

English canonical: [0040-immutable-fail-fast-config.md](../../adr/0040-immutable-fail-fast-config.md)
...
- デフォルト対必須のガバナンス: [ADR-0039](0039-config-default-vs-required-governance.ja.md)。
- 埋め込み env ファイルの仕組み: [ADR-0041](0041-embedded-self-contained-binary.ja.md)。
