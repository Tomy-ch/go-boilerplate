...
| Messaging / worker | `aws/aws-sdk-go-v2/service/sqs` | SQS クライアント（pull-ack worker）。配線は削除可能なサンプル群からのみ — [ADR-0049](../adr/0049-broker-sdk-isolation-measured-as-coupling.ja.md) 参照 |
