...
# ADR-0054: Propagate the outbox message_id as the receiver's Idempotency-Key
...
(see [ADR-0052](0052-at-least-once-outbox-poll.md)), meaning a receiver may observe the
...
- Related ADRs: [ADR-0051](0051-transactional-outbox.md), [ADR-0052](0052-at-least-once-outbox-poll.md).
