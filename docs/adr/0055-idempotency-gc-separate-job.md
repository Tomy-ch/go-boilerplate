...
# ADR-0055: Run idempotency key garbage collection as a separate one-shot CLI job
...
- Related: [ADR-0053](0053-idempotency-fixed-ttl.md) (fixed 24h TTL that the GC sweeps
  against).
