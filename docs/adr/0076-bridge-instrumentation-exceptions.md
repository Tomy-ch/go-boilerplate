...
# ADR-0076: Bridge / instrumentation libraries as bounded SRP exceptions
...
The library-selection policy ([ADR-0075](0075-library-selection-policy.md)) requires one
...
- The otel-contrib ones (`otelhttp`, `otelzap`) ship on **otel-contrib's monthly release
  ...
  (`github.com/labstack/echo-opentelemetry`, MIT — see [ADR-0020](0020-echo-http-framework.md))
...
- Parent policy: [ADR-0075](0075-library-selection-policy.md). Related gating decision: [ADR-0069](0069-config-driven-observability-gating.md).
