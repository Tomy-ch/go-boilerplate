...
# ADR-0025: Generate type-safe SQL access with sqlc
...
Given the SQL-first stance ([ADR-0024](0024-sql-first-data-access.md)), the handwritten SQL
...
- Builds on [ADR-0024](0024-sql-first-data-access.md) (SQL-first).
