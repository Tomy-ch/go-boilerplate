...
# ADR-0081: Local dev environment is provided via Docker Compose with profile-separated services
...
[ADR-0077](0077-containerized-pinned-toolchain.md)), which means tools run inside
...
- Container-based reproducibility rationale:
  [ADR-0077](0077-containerized-pinned-toolchain.md).
