...
# ADR-0104: Do not control scheduled-job concurrency in-app; delegate to the scheduler
...
scheduled job; see [ADR-0060](0060-relay-resident-gc-oneshot.md)). Each is designed to be
