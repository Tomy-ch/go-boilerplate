...
# ADR-0037: 量を 2 つのスケールで保持する — 精度は正確な十進、決済は最小単位の整数

English canonical: [0037-two-scale-quantity-model.md](0037-two-scale-quantity-model.md)
...
- 共有される業務意味を持つ金額の値オブジェクトの置き場所: [ADR-0038](0038-domain-lexicon.ja.md)。
