...
# ADR-0075: Generated-artifact drift gate + release-branch-centralized auto-generation bot
...
- Related: [ADR-0009](0009-openapi-first.md) — the OpenAPI-first contract that drives Go
  code generation.
- Related: [ADR-0020](0020-sqlc-type-safe-sql.md) — sqlc, the source of DB artifact
  generation.
