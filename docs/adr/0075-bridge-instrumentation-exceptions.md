...
# ADR-0075: Bridge / instrumentation libraries as bounded SRP exceptions
...
The library-selection policy ([ADR-0074](0074-library-selection-policy.md)) requires one
...
- The otel-contrib ones (`otelhttp`, `otelzap`) ship on **otel-contrib's monthly release
  ...
  (`github.com/labstack/echo-opentelemetry`, MIT — see [ADR-0019](0019-echo-http-framework.md))
