...
# ADR-0087: 生成成果物ドリフトゲートとリリースブランチ集約型自動生成ボット

English canonical: [0087-generated-artifact-drift-gate.md](0087-generated-artifact-drift-gate.md)
...
- 関連: [ADR-0026](0026-sqlc-type-safe-sql.ja.md) — DB 成果物生成のソースである sqlc。
