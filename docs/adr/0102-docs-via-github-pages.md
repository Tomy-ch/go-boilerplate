...
# ADR-0102: Publish static docs/ via GitHub Pages (released on production push)
...
documentation, design decisions, API references, and guides (see ADR-0010). This content
