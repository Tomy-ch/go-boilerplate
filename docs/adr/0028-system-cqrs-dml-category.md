...
# ADR-0028: Introduce system_cqrs as a fourth DML category outside the CQRS split
...
[ADR-0027](0027-lightweight-cqrs.md). It serves infrastructure concerns, not application
business logic.
...
- Related: [ADR-0027](0027-lightweight-cqrs.md) (CQRS split that system_cqrs falls
