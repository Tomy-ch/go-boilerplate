...
# ADR-0100: Do not control scheduled-job concurrency in-app; delegate to the scheduler
...
scheduled job; see [ADR-0056](0056-relay-resident-gc-oneshot.md)). Each is designed to be
