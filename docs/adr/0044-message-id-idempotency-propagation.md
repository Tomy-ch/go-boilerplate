...
# ADR-0044: Propagate the outbox message_id as the receiver's Idempotency-Key
...
(see [ADR-0042](0042-at-least-once-outbox-poll.md)), meaning a receiver may observe the
