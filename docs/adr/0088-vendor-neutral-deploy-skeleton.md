...
# ADR-0088: Deploy is a vendor-neutral skeleton (build/sign implemented; cloud CD is a template; registry not fixed)
...
- **Fully implemented** (no modification needed): image build, tagging, caching
  ...
  attestation (see [ADR-0087](0087-release-image-supply-chain.md)).
