...
# ADR-0021: Use merged DML and a dumped schema as sqlc's single input
...
- Related: [ADR-0019](0019-sql-first-data-access.md) (SQL-first data access),
  [ADR-0020](0020-sqlc-type-safe-sql.md) (sqlc as code generator).
