...
# ADR-0087: Generated-artifact drift gate + release-branch-centralized auto-generation bot
...
- Related: [ADR-0011](0011-openapi-first.md) — the OpenAPI-first contract that drives Go
  code generation.
- Related: [ADR-0026](0026-sqlc-type-safe-sql.md) — sqlc, the source of DB artifact
  generation.
