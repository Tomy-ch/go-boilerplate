...
# ADR-0059: リレーは常駐プロセス、GC はワンショット cron ジョブ

English canonical: [0059-relay-resident-gc-oneshot.md](0059-relay-resident-gc-oneshot.md)
...
- 関連 ADR: [ADR-0052](0052-transactional-outbox.ja.md)、[ADR-0057](0057-outbox-retention-gc.ja.md)。
