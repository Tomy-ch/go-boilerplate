...
# ADR-0036: Governance: default-in-code (immutable) vs required-in-file (variable)
...
[ADR-0037](0037-immutable-fail-fast-config.md)).
...
- Fail-fast startup behavior: [ADR-0037](0037-immutable-fail-fast-config.md).
