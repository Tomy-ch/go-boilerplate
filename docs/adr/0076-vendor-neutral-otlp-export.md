...
This decision is gated by [ADR-0075](0075-config-driven-observability-gating.md): a
...
create a second control plane. [ADR-0075](0075-config-driven-observability-gating.md)
...
- Config-driven gating: [ADR-0075](0075-config-driven-observability-gating.md).
