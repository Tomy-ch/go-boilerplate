...
# ADR-0054: Run idempotency key garbage collection as a separate one-shot CLI job
...
- Related: [ADR-0052](0052-idempotency-fixed-ttl.md) (fixed 24h TTL that the GC sweeps
  against).
