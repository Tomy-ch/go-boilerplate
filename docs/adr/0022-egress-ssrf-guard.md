...
# ADR-0022: Adopt an egress SSRF / dial-guard security posture for outbound HTTP
...
[ADR-0021](0021-outbound-http-resilience.md)).
...
- Related: [ADR-0021](0021-outbound-http-resilience.md) (resilience substrate that hosts
  this transport).
