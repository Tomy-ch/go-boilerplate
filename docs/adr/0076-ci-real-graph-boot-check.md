...
# ADR-0076: CI boots the real fx graph against real Postgres (startup verification)
...
- Related: [ADR-0031](0031-uber-fx-di.md) — the Uber fx DI container whose graph this
  check exercises.
- Related: [ADR-0040](0040-broker-agnostic-worker-scaffold.md) — the worker subsystem
