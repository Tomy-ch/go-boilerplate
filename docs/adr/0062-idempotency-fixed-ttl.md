...
# ADR-0062: Fix idempotency key TTL at 24 hours with no per-route configuration
...
- Related ADR-0064 (idempotency GC as a separate job) relies on this fixed TTL to keep
