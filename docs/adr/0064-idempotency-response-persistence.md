...
# ADR-0064: Persist the response body as JSON to enable deterministic replay (accepted PII tradeoff)
...
- The 24-hour TTL that bounds PII retention is decided in ADR-0063.
