...
# ADR-0091: CLI humble-object split (thin cmd/ shell + testable internal/cli core)
...
with the single-binary decision (see [ADR-0092](0092-single-multi-command-binary.md)).
