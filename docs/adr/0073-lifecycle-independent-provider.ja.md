...
# ADR-0073: オブザーバビリティプロバイダーはライフサイクル非依存（ProviderShutdowner）

English canonical: [0073-lifecycle-independent-provider.md](0073-lifecycle-independent-provider.md)
...
- 親: [ADR-0069](0069-config-driven-observability-gating.ja.md)。
