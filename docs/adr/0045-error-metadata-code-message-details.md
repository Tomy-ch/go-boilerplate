...
# ADR-0045: Protocol-neutral error metadata (code / message / details) on top of apperror
...
[ADR-0044](0044-apperror-protocol-agnostic-errors.md) established the protocol-agnostic
...
Three constraints keep ADR-0044 intact:
...
Let `Meta` override the HTTP status. Rejected: re-introduces the coupling ADR-0044
