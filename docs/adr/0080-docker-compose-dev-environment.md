...
# ADR-0080: Local dev environment is provided via Docker Compose with profile-separated services
...
[ADR-0076](0076-containerized-pinned-toolchain.md)), which means tools run inside
