...
# ADR-0025: Use sequential 6-digit migration IDs with CI-enforced gap and pair checks
...
[ADR-0024](0024-append-only-immutable-migrations.md) for the immutability rule that this
