...
# ADR-0105: Node パッケージはすべて pnpm で解決し、npm を使わない
...
クールダウン**（[ADR-0088 (malicious-package-detection-via-cooldown)](0088-malicious-package-detection-via-cooldown.ja.md)）
