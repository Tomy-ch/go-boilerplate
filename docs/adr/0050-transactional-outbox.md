...
# ADR-0050: Transactional outbox: emit events within the business transaction
...
- Related ADRs: [ADR-0051](0051-at-least-once-outbox-poll.md) (delivery guarantee), [ADR-0052](0052-skip-locked-outbox-relay.md) (relay concurrency).
