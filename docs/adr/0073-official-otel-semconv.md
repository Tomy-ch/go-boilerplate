...
結合が生まれ、[ADR-0072](0072-vendor-neutral-otlp-export.md) のベンダー中立の立場が
...
- 補完する決定: [ADR-0072](0072-vendor-neutral-otlp-export.md)（ベンダー中立エクスポート）。
- 親ゲーティング: [ADR-0071](0071-config-driven-observability-gating.md)。
