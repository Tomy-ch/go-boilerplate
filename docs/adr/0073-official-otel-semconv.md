...
[ADR-0072](0072-vendor-neutral-otlp-export.md). Vendor enrichment belongs in the
Collector pipeline.
...
- Complements: [ADR-0072](0072-vendor-neutral-otlp-export.md) (vendor-neutral export).
- Parent gating: [ADR-0071](0071-config-driven-observability-gating.md).
