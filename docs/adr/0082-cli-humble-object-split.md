...
# ADR-0082: CLI humble-object split (thin cmd/ shell + testable internal/cli core)
...
with the single-binary decision (see [ADR-0083](0083-single-multi-command-binary.md)).
