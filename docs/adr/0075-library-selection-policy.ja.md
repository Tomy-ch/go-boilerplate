...
# ADR-0075: 単一責任のライブラリ選定ポリシー

English canonical: [0075-library-selection-policy.md](0075-library-selection-policy.md)
...
（[ADR-0076](0076-bridge-instrumentation-exceptions.ja.md) 参照）。
...
- 親原則: [ADR-0001](0001-avoid-lock-in.ja.md)。例外: [ADR-0076](0076-bridge-instrumentation-exceptions.ja.md)。
