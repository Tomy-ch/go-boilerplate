...
# ADR-0070: Local dev environment is provided via Docker Compose with profile-separated services
...
[ADR-0066](0066-containerized-pinned-toolchain.md)), which means tools run inside
...
- Container-based reproducibility rationale:
  [ADR-0066](0066-containerized-pinned-toolchain.md).
