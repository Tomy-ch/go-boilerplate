...
# ADR-0044: Config is immutable, loaded once at startup, fail-fast
...
- Subsystem struct layout: [ADR-0042](0042-subsystem-typed-config-loaders.md).
- Default-vs-required governance: [ADR-0043](0043-config-default-vs-required-governance.md).
- Embedded env file mechanism: [ADR-0045](0045-embedded-self-contained-binary.md).
