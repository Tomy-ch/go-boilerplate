...
# ADR-0028: Ship master data via migration; keep transactional seed out of production
...
- Correcting a master data value (e.g., a misspelled prefecture name) requires a new
  ...
  [ADR-0026](0026-append-only-immutable-migrations.md).
...
- Related: [ADR-0026](0026-append-only-immutable-migrations.md) (immutability);
  [ADR-0027](0027-sequential-migration-ids.md) (numbering).
