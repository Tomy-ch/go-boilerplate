...
# ADR-0034: Use UUIDv7 (time-ordered) identifiers for all entity primary keys
...
- Related: [ADR-0024](0024-sqlc-type-safe-sql.md) (sqlc type overrides are the mechanism
