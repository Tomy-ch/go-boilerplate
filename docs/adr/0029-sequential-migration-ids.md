...
# ADR-0029: Use sequential 6-digit migration IDs with CI-enforced gap and pair checks
...
[ADR-0028](0028-append-only-immutable-migrations.md) for the immutability rule that this
