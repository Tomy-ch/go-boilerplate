...
# ADR-0065: Jobs deliberately have no broker, circuit breaker, drain, or health machinery
...
([ADR-0046](0046-broker-agnostic-worker-scaffold.md)) provides a rich operational layer:
...
- Contrast with [ADR-0046](0046-broker-agnostic-worker-scaffold.md) (worker: broker seam,
