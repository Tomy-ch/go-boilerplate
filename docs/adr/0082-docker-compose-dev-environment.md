...
# ADR-0082: Local dev environment is provided via Docker Compose with profile-separated services
...
[ADR-0078](0078-containerized-pinned-toolchain.md)), which means tools run inside
...
- Container-based reproducibility rationale:
  [ADR-0078](0078-containerized-pinned-toolchain.md).
