...
# ADR-0064: Jobs deliberately have no broker, circuit breaker, drain, or health machinery
...
([ADR-0045](0045-broker-agnostic-worker-scaffold.md)) provides a rich operational layer:
...
- Contrast with [ADR-0045](0045-broker-agnostic-worker-scaffold.md) (worker: broker seam,
