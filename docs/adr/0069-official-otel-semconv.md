...
# ADR-0069: Use only official OpenTelemetry semantic conventions; do not invent custom semconv or put vendor keys in typed config
...
[ADR-0068](0068-vendor-neutral-otlp-export.md). Vendor enrichment belongs in the
Collector pipeline.
...
- Complements: [ADR-0068](0068-vendor-neutral-otlp-export.md) (vendor-neutral export).
- Parent gating: [ADR-0067](0067-config-driven-observability-gating.md).
