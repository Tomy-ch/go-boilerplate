...
この決定は [ADR-0071](0071-config-driven-observability-gating.ja.md) によってゲーティングされる。
...
生み出す。[ADR-0071](0071-config-driven-observability-gating.ja.md) がこの却下を詳述している。
...
- 設定駆動ゲーティング: [ADR-0071](0071-config-driven-observability-gating.ja.md)。
