...
# ADR-0092: 生成成果物ドリフトゲートとリリースブランチ集約型自動生成ボット
...
- 関連: [ADR-0012](0012-openapi-first.ja.md) — Go コード生成を駆動する OpenAPI ファースト契約。
- 関連: [ADR-0027](0027-sqlc-type-safe-sql.ja.md) — DB 成果物生成のソースである sqlc。
