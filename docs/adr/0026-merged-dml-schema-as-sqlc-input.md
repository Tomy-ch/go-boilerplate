...
# ADR-0026: Use merged DML and a dumped schema as sqlc's single input
...
- Related: [ADR-0024](0024-sql-first-data-access.md) (SQL-first data access),
  [ADR-0025](0025-sqlc-type-safe-sql.md) (sqlc as code generator).
