...
# ADR-0092: CLI humble-object split (thin cmd/ shell + testable internal/cli core)
...
with the single-binary decision (see [ADR-0093](0093-single-multi-command-binary.md)).
