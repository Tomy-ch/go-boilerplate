...
# ADR-0057: 発行済み行の 7 日間保持 GC（10,000 件単位のバッチ）

English canonical: [0057-outbox-retention-gc.md](0057-outbox-retention-gc.md)
...
- 関連 ADR: [ADR-0056](0056-outbox-dead-after-max-attempts.ja.md)、[ADR-0059](0059-relay-resident-gc-oneshot.ja.md)。
