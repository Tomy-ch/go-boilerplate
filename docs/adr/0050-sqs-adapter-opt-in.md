...
# ADR-0050: SQS adapter is opt-in and not linked into the default binary

## Status

superseded by [ADR-0051](0051-broker-sdk-isolation-measured-as-coupling.md)

## Context

The worker scaffold ([ADR-0048](0048-broker-agnostic-worker-scaffold.md)) ships a reference
...
- Parent decision: [ADR-0048](0048-broker-agnostic-worker-scaffold.md). Principle: [ADR-0001](0001-avoid-lock-in.md).
