...
# ADR-0073: メトリクスは 2 経路を通る — OTLP プッシュと Prometheus スクレイプ

English canonical: [0073-dual-path-metrics.md](0073-dual-path-metrics.md)
...
- 親: [ADR-0070](0070-config-driven-observability-gating.ja.md)（設定駆動ゲーティング）。
