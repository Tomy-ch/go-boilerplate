...
# ADR-0045: Propagate the outbox message_id as the receiver's Idempotency-Key
...
(see [ADR-0043](0043-at-least-once-outbox-poll.md)), meaning a receiver may observe the
...
- Related ADRs: [ADR-0042](0042-transactional-outbox.md), [ADR-0043](0043-at-least-once-outbox-poll.md).
