...
# ADR-0068: Job は明示的に登録する（自動検出なし）

English canonical: [0068-job-explicit-registration.md](0068-job-explicit-registration.md)
...
本リポジトリは依存性注入に Uber Fx を使用しており（[ADR-0038](0038-uber-fx-di.ja.md) 参照）、
