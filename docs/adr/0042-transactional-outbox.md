...
# ADR-0042: Transactional outbox: emit events within the business transaction
...
- Related ADRs: [ADR-0043](0043-at-least-once-outbox-poll.md) (delivery guarantee), [ADR-0044](0044-skip-locked-outbox-relay.md) (relay concurrency).
