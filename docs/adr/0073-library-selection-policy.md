...
# ADR-0073: Single-responsibility library selection policy
...
exceptions (see [ADR-0074](0074-bridge-instrumentation-exceptions.md)).
...
- Parent principle: [ADR-0001](0001-avoid-lock-in.md). Exceptions: [ADR-0074](0074-bridge-instrumentation-exceptions.md).
