...
# ADR-0072: メトリクスは 2 経路を通る — OTLP プッシュと Prometheus スクレイプ

English canonical: [0072-dual-path-metrics.md](0072-dual-path-metrics.md)
...
- 親: [ADR-0069](0069-config-driven-observability-gating.ja.md)（設定駆動ゲーティング）。
