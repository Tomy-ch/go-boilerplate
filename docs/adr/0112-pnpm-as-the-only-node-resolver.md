...
control this repository relies on is a **publication cooldown** ([ADR-0095
(malicious-package-detection-via-cooldown)](0095-malicious-package-detection-via-cooldown.md)):
