...
# ADR-0040: Protocol-neutral error metadata (code / message / details) on top of apperror
...
[ADR-0039](0039-apperror-protocol-agnostic-errors.md) established the protocol-agnostic
...
Three constraints keep ADR-0039 intact:
...
Let `Meta` override the HTTP status. Rejected: re-introduces the coupling ADR-0039
