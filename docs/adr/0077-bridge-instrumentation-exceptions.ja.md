...
# ADR-0077: ブリッジ / 計装ライブラリを有界な SRP 例外として認める

English canonical: [0077-bridge-instrumentation-exceptions.md](0077-bridge-instrumentation-exceptions.md)
...
ライブラリ選定ポリシー（[ADR-0076](0076-library-selection-policy.ja.md)）は、責任が単一の
...
- otel-contrib 系（`otelhttp` / `otelzap`）は**otel-contrib の月次リリーストレイン**で
  ...
  （`github.com/labstack/echo-opentelemetry`、MIT — [ADR-0021](0021-echo-http-framework.ja.md) を参照）、
...
- 親ポリシー: [ADR-0076](0076-library-selection-policy.ja.md)。関連ゲーティング決定: [ADR-0070](0070-config-driven-observability-gating.ja.md)。
