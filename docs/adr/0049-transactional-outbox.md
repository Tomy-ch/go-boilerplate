...
# ADR-0049: Transactional outbox: emit events within the business transaction
...
- Related ADRs: [ADR-0050](0050-at-least-once-outbox-poll.md) (delivery guarantee), [ADR-0051](0051-skip-locked-outbox-relay.md) (relay concurrency).
