...
# ADR-0106: Resolve every Node package with pnpm; do not use npm
...
control this repository relies on is a **publication cooldown** ([ADR-0089
(malicious-package-detection-via-cooldown)](0089-malicious-package-detection-via-cooldown.md)):
