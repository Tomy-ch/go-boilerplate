...
# ADR-0043: Transactional outbox: emit events within the business transaction
...
- Related ADRs: [ADR-0044](0044-at-least-once-outbox-poll.md) (delivery guarantee), [ADR-0045](0045-skip-locked-outbox-relay.md) (relay concurrency).
