...
# ADR-0028: Use sequential 6-digit migration IDs with CI-enforced gap and pair checks
...
[ADR-0027](0027-append-only-immutable-migrations.md) for the immutability rule that this
