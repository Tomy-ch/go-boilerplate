...
| --- | --- | --- |
| Node packages | 7 days | `minimumReleaseAge` in each `pnpm-workspace.yaml`, refused at resolution time ([ADR-0112](0112-pnpm-as-the-only-node-resolver.md)) |
...
| CLI tools installed from PyPI | 7 days | `scripts/tool-cooldown`, reading the `python/*.in` declarations ([ADR-0084](0084-mise-ssot-drift-gate.md)) |
...
- Related: [ADR-0094](0094-sha-pinned-actions.md) (SHA pinning),
  [ADR-0093](0093-multi-layer-security-scanning.md) (the scanning layers this sits beside),
