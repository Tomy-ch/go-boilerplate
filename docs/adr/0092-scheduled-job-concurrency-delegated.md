...
# ADR-0092: Do not control scheduled-job concurrency in-app; delegate to the scheduler
...
scheduled job; see [ADR-0049](0049-relay-resident-gc-oneshot.md)). Each is designed to be
