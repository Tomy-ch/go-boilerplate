...
# ADR-0065: Bridge / instrumentation libraries as bounded SRP exceptions
...
The library-selection policy ([ADR-0064](0064-library-selection-policy.md)) requires one
...
- Parent policy: [ADR-0064](0064-library-selection-policy.md). Related gating decision: [ADR-0058](0058-config-driven-observability-gating.md).
