...
# ADR-0081: 運用スクリプトは scripts/ に TypeScript または Go で配置し、シェルスクリプトは使用しない

English canonical: [0081-scripts-in-node-go.md](0081-scripts-in-node-go.md)
...
- スクリプトを呼び出す Make ターゲットエントリポイント:
  [ADR-0080](0080-make-single-entrypoint.ja.md)。
