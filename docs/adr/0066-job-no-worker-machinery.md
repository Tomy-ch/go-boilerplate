...
# ADR-0066: Jobs deliberately have no broker, circuit breaker, drain, or health machinery
...
([ADR-0047](0047-broker-agnostic-worker-scaffold.md)) provides a rich operational layer:
...
- Contrast with [ADR-0047](0047-broker-agnostic-worker-scaffold.md) (worker: broker seam,
