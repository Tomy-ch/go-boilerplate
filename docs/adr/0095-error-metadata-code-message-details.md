...
# ADR-0095: Protocol-neutral error metadata (code / message / details) on top of apperror
...
[ADR-0038](0038-apperror-protocol-agnostic-errors.md) established the protocol-agnostic
...
Three constraints keep ADR-0038 intact:
...
Let `Meta` override the HTTP status. Rejected: re-introduces the coupling ADR-0038
