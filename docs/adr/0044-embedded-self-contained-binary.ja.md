...
# ADR-0044: go:embed で設定（.env）とマイグレーションをバンドルし、自己完結型バイナリを実現する

English canonical: [0044-embedded-self-contained-binary.md](0044-embedded-self-contained-binary.md)
...
- `FS` を消費する設定ロードシーケンスは [ADR-0043](0043-immutable-fail-fast-config.ja.md) に記載されている。
