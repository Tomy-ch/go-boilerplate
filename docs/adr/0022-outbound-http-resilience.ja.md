...
# ADR-0022: アウトバウンドHTTPレジリエンス基盤の提供（リトライ / サーキットブレーカー / リトライバジェット / デュアルタイムアウト）

English canonical: [0022-outbound-http-resilience.md](0022-outbound-http-resilience.md)
...
- トランスポート（インストルメンテーション + SSRFガード）: `internal/observability/http_client_transport.go` — [ADR-0023](0023-egress-ssrf-guard.ja.md)参照。
