...
# ADR-0047: Push-type brokers and streaming-log platforms are out of scope for the worker port
...
The broker-agnostic worker scaffold ([ADR-0046](0046-broker-agnostic-worker-scaffold.md))
...
worker port defined by [ADR-0046](0046-broker-agnostic-worker-scaffold.md). The exclusion
...
- Related: [ADR-0046](0046-broker-agnostic-worker-scaffold.md) (pull-ack worker scaffold,
