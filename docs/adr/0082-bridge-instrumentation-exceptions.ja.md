...
# ADR-0082: ブリッジ / 計装ライブラリを有界な SRP 例外として認める
...
ライブラリ選定ポリシー（[ADR-0081](0081-library-selection-policy.ja.md)）は、責任が単一の
...
- 親ポリシー: [ADR-0081](0081-library-selection-policy.ja.md)。関連ゲーティング決定: [ADR-0075](0075-config-driven-observability-gating.ja.md)。
