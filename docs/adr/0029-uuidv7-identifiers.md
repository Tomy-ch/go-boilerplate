...
# ADR-0029: Use UUIDv7 (time-ordered) identifiers for all entity primary keys
...
- Related: [ADR-0020](0020-sqlc-type-safe-sql.md) (sqlc type overrides are the mechanism
