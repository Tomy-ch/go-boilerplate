...
# ADR-0058: 発行済み行の 7 日間保持 GC（10,000 件単位のバッチ）

English canonical: [0058-outbox-retention-gc.md](0058-outbox-retention-gc.md)
...
- 関連 ADR: [ADR-0057](0057-outbox-dead-after-max-attempts.ja.md)、[ADR-0060](0060-relay-resident-gc-oneshot.ja.md)。
