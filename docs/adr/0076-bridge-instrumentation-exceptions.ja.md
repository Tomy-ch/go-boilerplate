...
# ADR-0076: ブリッジ / 計装ライブラリを有界な SRP 例外として認める

English canonical: [0076-bridge-instrumentation-exceptions.md](0076-bridge-instrumentation-exceptions.md)
...
ライブラリ選定ポリシー（[ADR-0075](0075-library-selection-policy.ja.md)）は、責任が単一の
...
- otel-contrib 系（`otelhttp` / `otelzap`）は**otel-contrib の月次リリーストレイン**で
  ...
  （`github.com/labstack/echo-opentelemetry`、MIT — [ADR-0020](0020-echo-http-framework.ja.md) を参照）、
...
- 親ポリシー: [ADR-0075](0075-library-selection-policy.ja.md)。関連ゲーティング決定: [ADR-0069](0069-config-driven-observability-gating.ja.md)。
