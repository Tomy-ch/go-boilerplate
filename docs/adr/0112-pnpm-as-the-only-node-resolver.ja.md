...
# ADR-0112: Node パッケージはすべて pnpm で解決し、npm を使わない
...
クールダウン**（[ADR-0095 (malicious-package-detection-via-cooldown)](0095-malicious-package-detection-via-cooldown.ja.md)）
