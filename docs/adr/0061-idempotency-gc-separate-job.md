...
# ADR-0061: Run idempotency key garbage collection as a separate one-shot CLI job
...
- Related: [ADR-0059](0059-idempotency-fixed-ttl.md) (fixed 24h TTL that the GC sweeps
  against).
