...
# ADR-0027: マージされたDMLおよびダンプされたスキーマをsqlcの単一入力として使用する

English canonical: [0027-merged-dml-schema-as-sqlc-input.md](0027-merged-dml-schema-as-sqlc-input.md)
...
- 関連: [ADR-0025](0025-sql-first-data-access.ja.md)（SQLファーストデータアクセス）、[ADR-0026](0026-sqlc-type-safe-sql.ja.md)（コードジェネレーターとしてのsqlc）。
