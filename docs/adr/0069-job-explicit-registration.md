...
# ADR-0069: Jobs are explicitly registered (no auto-discovery)
...
The repository uses Uber Fx for dependency injection (see [ADR-0039](0039-uber-fx-di.md)),
...
- Source: `docs/design/job.md` (§ 4 "What an integrator implements", intro sentence and
  registration table).
- Related: [ADR-0039](0039-uber-fx-di.md) (Uber Fx DI).
