...
# ADR-0062: Use only official OpenTelemetry semantic conventions; do not invent custom semconv or put vendor keys in typed config
...
[ADR-0061](0061-vendor-neutral-otlp-export.md). Vendor enrichment belongs in the
Collector pipeline.
...
- Complements: [ADR-0061](0061-vendor-neutral-otlp-export.md) (vendor-neutral export).
- Parent gating: [ADR-0060](0060-config-driven-observability-gating.md).
