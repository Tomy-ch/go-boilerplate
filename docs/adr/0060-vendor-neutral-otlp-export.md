...
# ADR-0060: Vendor-neutral OTLP-only export (delegate backend to the Collector)
...
This decision is gated by [ADR-0059](0059-config-driven-observability-gating.md): a
...
create a second control plane. [ADR-0059](0059-config-driven-observability-gating.md)
...
- Config-driven gating: [ADR-0059](0059-config-driven-observability-gating.md).
