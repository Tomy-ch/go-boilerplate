...
# ADR-0020: Optional authentication is allowed, and a failed authentication still denies the request
...
enforces the security requirements declared in the spec, and [ADR-0019](0019-metrics-endpoint-auth-exception.md)
...
- Related decision: [ADR-0019](0019-metrics-endpoint-auth-exception.md) (the other named authentication exception).
