...
# ADR-0052: Transactional outbox: emit events within the business transaction
...
- Related ADRs: [ADR-0053](0053-at-least-once-outbox-poll.md) (delivery guarantee), [ADR-0054](0054-skip-locked-outbox-relay.md) (relay concurrency).
