...
# ADR-0026: マージされたDMLおよびダンプされたスキーマをsqlcの単一入力として使用する

English canonical: [0026-merged-dml-schema-as-sqlc-input.md](0026-merged-dml-schema-as-sqlc-input.md)
...
- 関連: [ADR-0024](0024-sql-first-data-access.ja.md)（SQLファーストデータアクセス）、[ADR-0025](0025-sqlc-type-safe-sql.ja.md)（コードジェネレーターとしてのsqlc）。
