...
# ADR-0077: 再現性のために mise でバージョン固定されたコンテナ化ツールチェーンを使用する

English canonical: [0077-containerized-pinned-toolchain.md](0077-containerized-pinned-toolchain.md)
...
`python/*.in` と `python/*.txt`。[ADR-0078](0078-mise-ssot-drift-gate.ja.md)）、Docker イメージに
焼き込まれる。
