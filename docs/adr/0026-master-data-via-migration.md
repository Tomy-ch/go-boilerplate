...
# ADR-0026: Ship master data via migration; keep transactional seed out of production
...
- Correcting a master data value (e.g., a misspelled prefecture name) requires a new
  ...
  [ADR-0024](0024-append-only-immutable-migrations.md).
...
- Related: [ADR-0024](0024-append-only-immutable-migrations.md) (immutability);
  [ADR-0025](0025-sequential-migration-ids.md) (numbering).
