...
The library-selection policy ([ADR-0081](0081-library-selection-policy.md)) requires one
...
- Parent policy: [ADR-0081](0081-library-selection-policy.md). Related gating decision: [ADR-0075](0075-config-driven-observability-gating.md).
