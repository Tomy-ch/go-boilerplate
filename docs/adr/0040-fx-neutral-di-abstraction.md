...
# ADR-0040: Contain fx behind a neutral DI abstraction (Registrar / Shutdowner)
...
[ADR-0039](0039-uber-fx-di.md) adopts Uber Fx as the DI and lifecycle container.
...
- Parent decision: [ADR-0039](0039-uber-fx-di.md) (adopting Uber Fx).
