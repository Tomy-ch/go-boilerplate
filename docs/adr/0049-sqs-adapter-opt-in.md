...
# ADR-0049: SQS adapter is opt-in and not linked into the default binary

## Status

superseded by [ADR-0050](0050-broker-sdk-isolation-measured-as-coupling.md)

## Context

The worker scaffold ([ADR-0047](0047-broker-agnostic-worker-scaffold.md)) ships a reference
