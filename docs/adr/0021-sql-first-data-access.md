...
# ADR-0021: SQL-first data access
...
Go code is derived from it (see [ADR-0022](0022-sqlc-type-safe-sql.md)).
...
- The concrete type-safe generation mechanism is [ADR-0022](0022-sqlc-type-safe-sql.md) (sqlc).
