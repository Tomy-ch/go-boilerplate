...
# ADR-0082: ローカル開発環境はプロファイルで分離されたサービスを持つ Docker Compose で提供する

English canonical: [0082-docker-compose-dev-environment.md](0082-docker-compose-dev-environment.md)
...
ツール実行はマシン間で再現可能でなければならない（[ADR-0078](0078-containerized-pinned-toolchain.ja.md) 参照）。
