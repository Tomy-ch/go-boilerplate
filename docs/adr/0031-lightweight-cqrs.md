...
# ADR-0031: Adopt lightweight CQRS — Repository for writes, QueryService for reads
...
[ADR-0039](0039-uber-fx-di.md)). This is not full CQRS: there is no separate read store,
...
insufficient-stock rule as a fail-closed second net ([ADR-0035](0035-ordered-pessimistic-row-locks.md));
...
- Related: [ADR-0032](0032-system-cqrs-dml-category.md) (system_cqrs as a fourth, non-CQRS
  category).
