...
# ADR-0026: Generate type-safe SQL access with sqlc
...
Given the SQL-first stance ([ADR-0025](0025-sql-first-data-access.md)), the handwritten SQL
...
- Builds on [ADR-0025](0025-sql-first-data-access.md) (SQL-first).
