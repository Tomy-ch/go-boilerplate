...
# ADR-0034: Cross-aggregate value objects live in a curated domain lexicon
...
[ADR-0033](0033-two-scale-quantity-model.md)) belongs in `pkg/`.
...
- Two-scale quantity model this enables: [ADR-0033](0033-two-scale-quantity-model.md).
