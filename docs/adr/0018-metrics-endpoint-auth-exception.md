...
# ADR-0018: /metrics is an auth exception — outside OpenAPI validation, protected by a separate BasicAuth middleware
...
- Related decision: [ADR-0015](0015-spec-driven-request-validation.md) (spec-driven request validation — this ADR is its companion exception record).
