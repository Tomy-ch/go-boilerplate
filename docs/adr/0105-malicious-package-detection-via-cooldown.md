...
# ADR-0105: Accept a publication cooldown as the primary defence against malicious packages, without a dedicated detector
...
- Related: [ADR-0081](0081-sha-pinned-actions.md) (SHA pinning),
  [ADR-0080](0080-multi-layer-security-scanning.md) (the scanning layers this sits beside),
