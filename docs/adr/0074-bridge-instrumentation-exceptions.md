...
# ADR-0074: Bridge / instrumentation libraries as bounded SRP exceptions
...
The library-selection policy ([ADR-0073](0073-library-selection-policy.md)) requires one
...
- Parent policy: [ADR-0073](0073-library-selection-policy.md). Related gating decision: [ADR-0067](0067-config-driven-observability-gating.md).
