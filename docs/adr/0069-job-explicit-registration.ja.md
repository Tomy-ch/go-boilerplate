...
# ADR-0069: Job は明示的に登録する（自動検出なし）

English canonical: [0069-job-explicit-registration.md](0069-job-explicit-registration.md)
...
本リポジトリは依存性注入に Uber Fx を使用しており（[ADR-0039](0039-uber-fx-di.ja.md) 参照）、
