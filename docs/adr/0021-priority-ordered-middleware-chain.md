...
# ADR-0021: Build the middleware chain as a priority-ordered, data-driven list
...
The project uses [ADR-0038](0038-uber-fx-di.md) (Uber fx) for dependency injection. Each
