...
# ADR-0068: Jobs deliberately have no broker, circuit breaker, drain, or health machinery
...
([ADR-0049](0049-broker-agnostic-worker-scaffold.md)) provides a rich operational layer:
...
- Contrast with [ADR-0049](0049-broker-agnostic-worker-scaffold.md) (worker: broker seam,
