...
# ADR-0078: 再現性のために mise でバージョン固定されたコンテナ化ツールチェーンを使用する

English canonical: [0078-containerized-pinned-toolchain.md](0078-containerized-pinned-toolchain.md)
...
`python/*.in` と `python/*.txt`。[ADR-0079](0079-mise-ssot-drift-gate.ja.md)）、Docker イメージに
焼き込まれる。
