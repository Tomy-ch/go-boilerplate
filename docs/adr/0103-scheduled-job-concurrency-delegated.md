...
# ADR-0103: Do not control scheduled-job concurrency in-app; delegate to the scheduler
...
scheduled job; see [ADR-0059](0059-relay-resident-gc-oneshot.md)). Each is designed to be
