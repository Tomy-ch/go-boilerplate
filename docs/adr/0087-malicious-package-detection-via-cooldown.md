...
# ADR-0087: Accept a publication cooldown as the primary defence against malicious packages, without a dedicated detector
...
| CLI tools installed from PyPI | 7 days | `scripts/tool-cooldown`, reading the `python/*.in` declarations ([ADR-0076](0076-mise-ssot-drift-gate.md)) |
...
- Related: [ADR-0086](0086-sha-pinned-actions.md) (SHA pinning),
  [ADR-0085](0085-multi-layer-security-scanning.md) (the scanning layers this sits beside),
