...
# ADR-0049: Measure broker-SDK isolation as coupling, not as linkage
...
form stand literally. Rejected for now: ADR-0048 already rejected build tags for this purpose, and a binary
