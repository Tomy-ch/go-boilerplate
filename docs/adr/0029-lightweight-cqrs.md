...
# ADR-0029: Adopt lightweight CQRS — Repository for writes, QueryService for reads
...
[ADR-0037](0037-uber-fx-di.md)). This is not full CQRS: there is no separate read store,
...
insufficient-stock rule as a fail-closed second net ([ADR-0033](0033-ordered-pessimistic-row-locks.md));
...
- Related: [ADR-0030](0030-system-cqrs-dml-category.md) (system_cqrs as a fourth, non-CQRS
  category).
