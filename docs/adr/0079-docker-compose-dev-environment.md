...
# ADR-0079: Local dev environment is provided via Docker Compose with profile-separated services
...
[ADR-0075](0075-containerized-pinned-toolchain.md)), which means tools run inside
...
- Container-based reproducibility rationale:
  [ADR-0075](0075-containerized-pinned-toolchain.md).
