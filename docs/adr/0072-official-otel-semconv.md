...
# ADR-0072: Use only official OpenTelemetry semantic conventions; do not invent custom semconv or put vendor keys in typed config
...
[ADR-0071](0071-vendor-neutral-otlp-export.md). Vendor enrichment belongs in the
Collector pipeline.
...
- Complements: [ADR-0071](0071-vendor-neutral-otlp-export.md) (vendor-neutral export).
- Parent gating: [ADR-0070](0070-config-driven-observability-gating.md).
