...
# ADR-0067: Jobs deliberately have no broker, circuit breaker, drain, or health machinery
...
([ADR-0048](0048-broker-agnostic-worker-scaffold.md)) provides a rich operational layer:
...
- Contrast with [ADR-0048](0048-broker-agnostic-worker-scaffold.md) (worker: broker seam,
