...
# ADR-0055: Propagate the outbox message_id as the receiver's Idempotency-Key
...
(see [ADR-0053](0053-at-least-once-outbox-poll.md)), meaning a receiver may observe the
...
- Related ADRs: [ADR-0052](0052-transactional-outbox.md), [ADR-0053](0053-at-least-once-outbox-poll.md).
