...
# ADR-0077: Bridge / instrumentation libraries as bounded SRP exceptions
...
The library-selection policy ([ADR-0076](0076-library-selection-policy.md)) requires one
...
- The otel-contrib ones (`otelhttp`, `otelzap`) ship on **otel-contrib's monthly release
  ...
  (`github.com/labstack/echo-opentelemetry`, MIT — see [ADR-0021](0021-echo-http-framework.md))
...
- Parent policy: [ADR-0076](0076-library-selection-policy.md). Related gating decision: [ADR-0070](0070-config-driven-observability-gating.md).
