...
# ADR-0053: Propagate the outbox message_id as the receiver's Idempotency-Key
...
(see [ADR-0051](0051-at-least-once-outbox-poll.md)), meaning a receiver may observe the
...
- Related ADRs: [ADR-0050](0050-transactional-outbox.md), [ADR-0051](0051-at-least-once-outbox-poll.md).
