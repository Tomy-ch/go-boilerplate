...
# ADR-0020: Adopt an egress SSRF / dial-guard security posture for outbound HTTP
...
[ADR-0019](0019-outbound-http-resilience.md)).
...
- Related: [ADR-0019](0019-outbound-http-resilience.md) (resilience substrate that hosts
  this transport).
