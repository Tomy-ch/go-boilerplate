...
# ADR-0041: Governance: default-in-code (immutable) vs required-in-file (variable)
...
[ADR-0042](0042-immutable-fail-fast-config.md)).
...
- Fail-fast startup behavior: [ADR-0042](0042-immutable-fail-fast-config.md).
