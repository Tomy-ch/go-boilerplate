...
# ADR-0078: Local dev environment is provided via Docker Compose with profile-separated services
...
[ADR-0074](0074-containerized-pinned-toolchain.md)), which means tools run inside
