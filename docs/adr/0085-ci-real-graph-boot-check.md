...
# ADR-0085: CI boots the real fx graph against real Postgres (startup verification)
...
- Related: [ADR-0038](0038-uber-fx-di.md) — the Uber fx DI container whose graph this
  check exercises.
- Related: [ADR-0048](0048-broker-agnostic-worker-scaffold.md) — the worker subsystem
