...
# ADR-0012: Author the spec in modular Redocly files, bundle, then generate
...
[ADR-0011](0011-openapi-first.md) establishes that OpenAPI is the single source of truth
...
3. **Generate** — oapi-codegen reads `openapi/openapi.gen.yaml` to produce Go code (see
   [ADR-0013](0013-oapi-codegen-strict-server.md)).
