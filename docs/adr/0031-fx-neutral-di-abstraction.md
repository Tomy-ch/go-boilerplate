...
# ADR-0031: Contain fx behind a neutral DI abstraction (Registrar / Shutdowner)
...
[ADR-0030](0030-uber-fx-di.md) adopts Uber Fx as the DI and lifecycle container.
...
- Parent decision: [ADR-0030](0030-uber-fx-di.md) (adopting Uber Fx).
