...
# ADR-0043: Protocol-neutral error metadata (code / message / details) on top of apperror
...
[ADR-0042](0042-apperror-protocol-agnostic-errors.md) established the protocol-agnostic
...
Three constraints keep ADR-0042 intact:
...
Let `Meta` override the HTTP status. Rejected: re-introduces the coupling ADR-0042
