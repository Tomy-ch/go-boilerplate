...
# ADR-0053: Transactional outbox: emit events within the business transaction
...
- Related ADRs: [ADR-0054](0054-at-least-once-outbox-poll.md) (delivery guarantee), [ADR-0055](0055-skip-locked-outbox-relay.md) (relay concurrency).
