...
# ADR-0063: Fix idempotency key TTL at 24 hours with no per-route configuration
...
- Related ADR-0065 (idempotency GC as a separate job) relies on this fixed TTL to keep
