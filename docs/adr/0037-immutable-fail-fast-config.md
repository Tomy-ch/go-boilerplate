...
# ADR-0037: Config is immutable, loaded once at startup, fail-fast
...
- Subsystem struct layout: [ADR-0035](0035-subsystem-typed-config-loaders.md).
- Default-vs-required governance: [ADR-0036](0036-config-default-vs-required-governance.md).
- Embedded env file mechanism: [ADR-0038](0038-embedded-self-contained-binary.md).
