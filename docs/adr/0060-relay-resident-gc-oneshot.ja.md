...
# ADR-0060: リレーは常駐プロセス、GC はワンショット cron ジョブ

English canonical: [0060-relay-resident-gc-oneshot.md](0060-relay-resident-gc-oneshot.md)
...
- 関連 ADR: [ADR-0053](0053-transactional-outbox.ja.md)、[ADR-0058](0058-outbox-retention-gc.ja.md)。
