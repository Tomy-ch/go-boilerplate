...
# ADR-0023: Use merged DML and a dumped schema as sqlc's single input
...
- Related: [ADR-0021](0021-sql-first-data-access.md) (SQL-first data access),
  [ADR-0022](0022-sqlc-type-safe-sql.md) (sqlc as code generator).
