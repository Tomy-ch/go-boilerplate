...
# ADR-0027: Use sequential 6-digit migration IDs with CI-enforced gap and pair checks
...
[ADR-0026](0026-append-only-immutable-migrations.md) for the immutability rule that this
