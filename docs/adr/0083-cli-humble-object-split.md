...
# ADR-0083: CLI humble-object split (thin cmd/ shell + testable internal/cli core)
...
with the single-binary decision (see [ADR-0084](0084-single-multi-command-binary.md)).
