...
# ADR-0072: Local dev environment is provided via Docker Compose with profile-separated services
...
[ADR-0068](0068-containerized-pinned-toolchain.md)), which means tools run inside
...
- Container-based reproducibility rationale:
  [ADR-0068](0068-containerized-pinned-toolchain.md).
