...
# ADR-0025: Use merged DML and a dumped schema as sqlc's single input
...
- Related: [ADR-0023](0023-sql-first-data-access.md) (SQL-first data access),
  [ADR-0024](0024-sqlc-type-safe-sql.md) (sqlc as code generator).
