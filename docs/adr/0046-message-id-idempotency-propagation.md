...
# ADR-0046: Propagate the outbox message_id as the receiver's Idempotency-Key
...
(see [ADR-0044](0044-at-least-once-outbox-poll.md)), meaning a receiver may observe the
...
- Related ADRs: [ADR-0043](0043-transactional-outbox.md), [ADR-0044](0044-at-least-once-outbox-poll.md).
