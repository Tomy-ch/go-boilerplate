...
# ADR-0023: アウトバウンドHTTPレジリエンス基盤の提供（リトライ / サーキットブレーカー / リトライバジェット / デュアルタイムアウト）

English canonical: [0023-outbound-http-resilience.md](0023-outbound-http-resilience.md)
...
- トランスポート（インストルメンテーション + SSRFガード）: `internal/observability/http_client_transport.go` — [ADR-0024](0024-egress-ssrf-guard.ja.md)参照。
