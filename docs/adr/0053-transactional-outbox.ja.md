...
# ADR-0053: トランザクショナルアウトボックス — ビジネストランザクション内でイベントを発行する

English canonical: [0053-transactional-outbox.md](0053-transactional-outbox.md)
...
- 関連 ADR: [ADR-0054](0054-at-least-once-outbox-poll.ja.md)（デリバリー保証）、[ADR-0055](0055-skip-locked-outbox-relay.ja.md)（リレー並行性）。
