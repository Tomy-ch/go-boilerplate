...
# ADR-0024: Adopt an egress SSRF / dial-guard security posture for outbound HTTP
...
[ADR-0023](0023-outbound-http-resilience.md)).
...
- Related: [ADR-0023](0023-outbound-http-resilience.md) (resilience substrate that hosts
  this transport).
