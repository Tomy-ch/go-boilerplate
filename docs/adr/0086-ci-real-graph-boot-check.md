...
# ADR-0086: CI boots the real fx graph against real Postgres (startup verification)
...
- Related: [ADR-0039](0039-uber-fx-di.md) — the Uber fx DI container whose graph this
  check exercises.
- Related: [ADR-0049](0049-broker-agnostic-worker-scaffold.md) — the worker subsystem
