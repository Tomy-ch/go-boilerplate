...
# ADR-0067: Bridge / instrumentation libraries as bounded SRP exceptions
...
The library-selection policy ([ADR-0066](0066-library-selection-policy.md)) requires one
...
- Parent policy: [ADR-0066](0066-library-selection-policy.md). Related gating decision: [ADR-0060](0060-config-driven-observability-gating.md).
