...
# ADR-0030: Adopt lightweight CQRS — Repository for writes, QueryService for reads
...
[ADR-0038](0038-uber-fx-di.md)). This is not full CQRS: there is no separate read store,
...
insufficient-stock rule as a fail-closed second net ([ADR-0034](0034-ordered-pessimistic-row-locks.md));
...
- Related: [ADR-0031](0031-system-cqrs-dml-category.md) (system_cqrs as a fourth, non-CQRS
  category).
