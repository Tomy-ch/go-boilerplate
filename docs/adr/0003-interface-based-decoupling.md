...
- DI resolution (see ADR-0031) wires implementations to interfaces at startup, so the
...
- Layer dependency rules and the forbidden import table: [`docs/rules.md`](../rules.md)
  ...
  Rules".
- The DI container that wires implementations to interfaces at startup: ADR-0031.
