...
- バージョン管理、プッシュ、プルのための 1 つのビルド成果物。同じイメージをコマンドオーバーライドで任意のロールとして実行できる（[ADR-0097](0097-single-runtime-image.ja.md) 参照）。
...
- コマンドロジックは [ADR-0095](0095-cli-humble-object-split.ja.md) に従って `internal/cli/<command>/` に置かれる。
