...
# ADR-0101: Deploy is a vendor-neutral skeleton (build/sign implemented; cloud CD is a stub; registry not fixed)
...
- **Fully implemented** (no modification needed): image build, tagging, caching
  ...
  attestation (see [ADR-0100](0100-release-image-supply-chain.md)).
