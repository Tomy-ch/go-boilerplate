...
# ADR-0040: Governance: default-in-code (immutable) vs required-in-file (variable)
...
[ADR-0041](0041-immutable-fail-fast-config.md)).
...
- Fail-fast startup behavior: [ADR-0041](0041-immutable-fail-fast-config.md).
