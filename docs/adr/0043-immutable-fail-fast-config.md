...
# ADR-0043: Config is immutable, loaded once at startup, fail-fast
...
- Subsystem struct layout: [ADR-0041](0041-subsystem-typed-config-loaders.md).
- Default-vs-required governance: [ADR-0042](0042-config-default-vs-required-governance.md).
- Embedded env file mechanism: [ADR-0044](0044-embedded-self-contained-binary.md).
