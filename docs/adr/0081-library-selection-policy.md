...
exceptions (see [ADR-0082](0082-bridge-instrumentation-exceptions.md)).
...
- Parent principle: [ADR-0001](0001-avoid-lock-in.md). Exceptions: [ADR-0082](0082-bridge-instrumentation-exceptions.md).
