...
# ADR-0065: Run idempotency key garbage collection as a separate one-shot CLI job
...
- Related: [ADR-0063](0063-idempotency-fixed-ttl.md) (fixed 24h TTL that the GC sweeps
  against).
