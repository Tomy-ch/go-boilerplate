...
# ADR-0048: Push-type brokers and streaming-log platforms are out of scope for the worker port
...
The broker-agnostic worker scaffold ([ADR-0047](0047-broker-agnostic-worker-scaffold.md))
...
worker port defined by [ADR-0047](0047-broker-agnostic-worker-scaffold.md). The exclusion
