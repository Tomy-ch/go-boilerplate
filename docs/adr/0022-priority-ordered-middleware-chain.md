...
# ADR-0022: Build the middleware chain as a priority-ordered, data-driven list
...
The project uses [ADR-0039](0039-uber-fx-di.md) (Uber fx) for dependency injection. Each
