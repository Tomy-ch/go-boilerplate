...
# ADR-0074: オブザーバビリティプロバイダーはライフサイクル非依存（ProviderShutdowner）

English canonical: [0074-lifecycle-independent-provider.md](0074-lifecycle-independent-provider.md)
...
- 親: [ADR-0070](0070-config-driven-observability-gating.ja.md)。
