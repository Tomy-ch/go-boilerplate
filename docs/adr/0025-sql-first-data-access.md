...
# ADR-0025: SQL-first data access
...
Go code is derived from it (see [ADR-0026](0026-sqlc-type-safe-sql.md)).
...
- The concrete type-safe generation mechanism is [ADR-0026](0026-sqlc-type-safe-sql.md) (sqlc).
