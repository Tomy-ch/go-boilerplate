...
# ADR-0063: Run idempotency key garbage collection as a separate one-shot CLI job
...
- Related: [ADR-0061](0061-idempotency-fixed-ttl.md) (fixed 24h TTL that the GC sweeps
  against).
