...
# ADR-0022: Generate type-safe SQL access with sqlc
...
Given the SQL-first stance ([ADR-0021](0021-sql-first-data-access.md)), the handwritten SQL
...
- Builds on [ADR-0021](0021-sql-first-data-access.md) (SQL-first).
