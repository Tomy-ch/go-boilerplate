...
# ADR-0036: Contain fx behind a neutral DI abstraction (Registrar / Shutdowner)
...
[ADR-0035](0035-uber-fx-di.md) adopts Uber Fx as the DI and lifecycle container.
...
- Parent decision: [ADR-0035](0035-uber-fx-di.md) (adopting Uber Fx).
