...
# ADR-0102: Ship a balanced outbox relay; delegate hardening to operational evidence
...
than by structural exclusion: `message_id` propagates as `Idempotency-Key` ([ADR-0052]) and the
