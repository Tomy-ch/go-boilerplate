...
# ADR-0041: Transactional outbox: emit events within the business transaction
...
- Related ADRs: [ADR-0042](0042-at-least-once-outbox-poll.md) (delivery guarantee), [ADR-0043](0043-skip-locked-outbox-relay.md) (relay concurrency).
