...
# ADR-0073: Bridge / instrumentation libraries as bounded SRP exceptions
...
The library-selection policy ([ADR-0072](0072-library-selection-policy.md)) requires one
...
- Parent policy: [ADR-0072](0072-library-selection-policy.md). Related gating decision: [ADR-0066](0066-config-driven-observability-gating.md).
