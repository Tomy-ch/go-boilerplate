...
# ADR-0080: 運用スクリプトは scripts/ に TypeScript または Go で配置し、シェルスクリプトは使用しない

English canonical: [0080-scripts-in-node-go.md](0080-scripts-in-node-go.md)
...
- スクリプトを呼び出す Make ターゲットエントリポイント:
  [ADR-0079](0079-make-single-entrypoint.ja.md)。
