...
# ADR-0013: Generate per tag/handler with oapi-codegen in strict-server mode
...
[ADR-0011](0011-openapi-first.md) requires that server code is generated from the OpenAPI
...
- Regeneration requires the bundled `openapi.gen.yaml` to exist first (see
  [ADR-0012](0012-redocly-modular-spec-pipeline.md)).
...
- Spec bundling prerequisite: [ADR-0012](0012-redocly-modular-spec-pipeline.md).
