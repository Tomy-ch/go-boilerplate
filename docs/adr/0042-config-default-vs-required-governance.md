...
# ADR-0042: Governance: default-in-code (immutable) vs required-in-file (variable)
...
[ADR-0043](0043-immutable-fail-fast-config.md)).
...
- Fail-fast startup behavior: [ADR-0043](0043-immutable-fail-fast-config.md).
