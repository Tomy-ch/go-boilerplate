...
# ADR-0093: Do not control scheduled-job concurrency in-app; delegate to the scheduler
...
scheduled job; see [ADR-0050](0050-relay-resident-gc-oneshot.md)). Each is designed to be
