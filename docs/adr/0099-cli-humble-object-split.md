...
The coverage gate ([ADR-0090](0090-coverage-hard-gate.md), 90%+ branch coverage) must apply to command logic, but `cmd/` shell files
...
with the single-binary decision (see [ADR-0100](0100-single-multi-command-binary.md)).
