...
# ADR-0056: Propagate the outbox message_id as the receiver's Idempotency-Key
...
(see [ADR-0054](0054-at-least-once-outbox-poll.md)), meaning a receiver may observe the
...
- Related ADRs: [ADR-0053](0053-transactional-outbox.md), [ADR-0054](0054-at-least-once-outbox-poll.md).
