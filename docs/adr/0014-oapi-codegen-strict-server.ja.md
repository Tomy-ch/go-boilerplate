...
- 再生成にはバンドルされた `openapi.gen.yaml` が先に存在する必要がある（[ADR-0013](0013-redocly-modular-spec-pipeline.ja.md) 参照）。
...
- 仕様バンドルの前提条件: [ADR-0013](0013-redocly-modular-spec-pipeline.ja.md)。
