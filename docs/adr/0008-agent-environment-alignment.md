...
shape of ADR-0097. The `ci-first` load band deliberately delegates heavy local gates to CI when a
...
- Related mechanisms: ADR-0006, ADR-0007, ADR-0009, ADR-0093, and ADR-0097.
