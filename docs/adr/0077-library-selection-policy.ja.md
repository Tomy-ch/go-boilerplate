...
（[ADR-0078](0078-bridge-instrumentation-exceptions.ja.md) 参照）。
...
- 親原則: [ADR-0001](0001-avoid-lock-in.ja.md)。例外: [ADR-0078](0078-bridge-instrumentation-exceptions.ja.md)。
