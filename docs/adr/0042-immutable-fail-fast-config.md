...
# ADR-0042: Config is immutable, loaded once at startup, fail-fast
...
- Subsystem struct layout: [ADR-0040](0040-subsystem-typed-config-loaders.md).
- Default-vs-required governance: [ADR-0041](0041-config-default-vs-required-governance.md).
- Embedded env file mechanism: [ADR-0043](0043-embedded-self-contained-binary.md).
