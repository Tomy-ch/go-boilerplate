...
# ADR-0047: Broker-agnostic pull-ack worker scaffold
...
- The port is deliberately narrow (pull-ack only); push and streaming-log models do not fit
  and are excluded (recorded separately as ADR-0048, materialized in Phase 4).
...
[ADR-0049](0049-sqs-adapter-opt-in.md)).
