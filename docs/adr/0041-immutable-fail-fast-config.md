...
# ADR-0041: Config is immutable, loaded once at startup, fail-fast
...
- Subsystem struct layout: [ADR-0039](0039-subsystem-typed-config-loaders.md).
- Default-vs-required governance: [ADR-0040](0040-config-default-vs-required-governance.md).
- Embedded env file mechanism: [ADR-0042](0042-embedded-self-contained-binary.md).
