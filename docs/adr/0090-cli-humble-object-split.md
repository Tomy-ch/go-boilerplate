...
# ADR-0090: CLI humble-object split (thin cmd/ shell + testable internal/cli core)
...
with the single-binary decision (see [ADR-0091](0091-single-multi-command-binary.md)).
