...
# ADR-0033: Use UUIDv7 (time-ordered) identifiers for all entity primary keys
...
- Related: [ADR-0022](0022-sqlc-type-safe-sql.md) (sqlc type overrides are the mechanism
