...
# ADR-0016: Designate the domain layer as the sole authority for business-validity rules
...
- This authority model is the prerequisite for the direction invariant in ADR-0017
...
- The downstream constraint relationship (direction invariant: `request ⊆ domain ⊆
  response`) is specified in ADR-0017 (境界値の所有権 / boundary value ownership). This
  ADR establishes the authority model that makes that invariant coherent; ADR-0017
