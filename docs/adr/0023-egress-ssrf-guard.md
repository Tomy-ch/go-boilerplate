...
# ADR-0023: Adopt an egress SSRF / dial-guard security posture for outbound HTTP
...
[ADR-0022](0022-outbound-http-resilience.md)).
...
- Related: [ADR-0022](0022-outbound-http-resilience.md) (resilience substrate that hosts
  this transport).
