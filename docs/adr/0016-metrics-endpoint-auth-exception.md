...
# ADR-0016: /metrics is an auth exception — outside OpenAPI validation, protected by a separate BasicAuth middleware
...
[ADR-0013](0013-spec-driven-request-validation.md) establishes that the OpenAPI middleware
...
- Related decision: [ADR-0013](0013-spec-driven-request-validation.md) (spec-driven request validation — this ADR is its companion exception record).
