...
# ADR-0020: Build the middleware chain as a priority-ordered, data-driven list
...
The project uses [ADR-0037](0037-uber-fx-di.md) (Uber fx) for dependency injection. Each
