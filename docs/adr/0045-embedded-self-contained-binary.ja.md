...
# ADR-0045: go:embed で設定（.env）とマイグレーションをバンドルし、自己完結型バイナリを実現する

English canonical: [0045-embedded-self-contained-binary.md](0045-embedded-self-contained-binary.md)
...
- `FS` を消費する設定ロードシーケンスは [ADR-0044](0044-immutable-fail-fast-config.ja.md) に記載されている。
