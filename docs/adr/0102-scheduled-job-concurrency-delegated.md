...
# ADR-0102: Do not control scheduled-job concurrency in-app; delegate to the scheduler
...
scheduled job; see [ADR-0058](0058-relay-resident-gc-oneshot.md)). Each is designed to be
