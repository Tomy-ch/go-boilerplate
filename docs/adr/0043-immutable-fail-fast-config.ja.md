...
# ADR-0043: 設定は不変、起動時に 1 回だけロード、フェイルファスト

English canonical: [0043-immutable-fail-fast-config.md](0043-immutable-fail-fast-config.md)
...
- デフォルト対必須のガバナンス: [ADR-0042](0042-config-default-vs-required-governance.ja.md)。
- 埋め込み env ファイルの仕組み: [ADR-0044](0044-embedded-self-contained-binary.ja.md)。
