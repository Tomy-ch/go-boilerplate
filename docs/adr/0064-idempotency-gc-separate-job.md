...
# ADR-0064: Run idempotency key garbage collection as a separate one-shot CLI job
...
- Related: [ADR-0062](0062-idempotency-fixed-ttl.md) (fixed 24h TTL that the GC sweeps
  against).
