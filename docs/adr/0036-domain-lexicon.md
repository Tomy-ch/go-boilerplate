...
# ADR-0036: Cross-aggregate value objects live in a curated domain lexicon
...
Introducing `money.Price` ([ADR-0035](0035-two-scale-quantity-model.md)) surfaced a gap in the
...
[ADR-0035](0035-two-scale-quantity-model.md)) belongs in `pkg/`.
...
- Two-scale quantity model this enables: [ADR-0035](0035-two-scale-quantity-model.md).
