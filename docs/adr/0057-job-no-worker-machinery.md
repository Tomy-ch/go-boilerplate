...
# ADR-0057: Jobs deliberately have no broker, circuit breaker, drain, or health machinery
...
([ADR-0039](0039-broker-agnostic-worker-scaffold.md)) provides a rich operational layer:
...
- Contrast with [ADR-0039](0039-broker-agnostic-worker-scaffold.md) (worker: broker seam,
