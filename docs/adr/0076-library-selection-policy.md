...
# ADR-0076: Single-responsibility library selection policy
...
exceptions (see [ADR-0077](0077-bridge-instrumentation-exceptions.md)).
...
- Parent principle: [ADR-0001](0001-avoid-lock-in.md). Exceptions: [ADR-0077](0077-bridge-instrumentation-exceptions.md).
