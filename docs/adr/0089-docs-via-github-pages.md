...
# ADR-0089: Publish static docs/ via GitHub Pages (released on production push)
...
- `.github/workflows/deploy-docs.yaml` lines 1-45 are the complete workflow definition.
