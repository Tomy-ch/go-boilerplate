...
# ADR-0052: トランザクショナルアウトボックス — ビジネストランザクション内でイベントを発行する

English canonical: [0052-transactional-outbox.md](0052-transactional-outbox.md)
...
- 関連 ADR: [ADR-0053](0053-at-least-once-outbox-poll.ja.md)（デリバリー保証）、[ADR-0054](0054-skip-locked-outbox-relay.ja.md)（リレー並行性）。
