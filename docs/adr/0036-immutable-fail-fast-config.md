...
# ADR-0036: Config is immutable, loaded once at startup, fail-fast
...
- Subsystem struct layout: [ADR-0034](0034-subsystem-typed-config-loaders.md).
- Default-vs-required governance: [ADR-0035](0035-config-default-vs-required-governance.md).
- Embedded env file mechanism: [ADR-0037](0037-embedded-self-contained-binary.md).
