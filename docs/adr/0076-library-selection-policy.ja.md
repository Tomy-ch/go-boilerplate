...
# ADR-0076: 単一責任のライブラリ選定ポリシー

English canonical: [0076-library-selection-policy.md](0076-library-selection-policy.md)
...
（[ADR-0077](0077-bridge-instrumentation-exceptions.ja.md) 参照）。
...
- 親原則: [ADR-0001](0001-avoid-lock-in.ja.md)。例外: [ADR-0077](0077-bridge-instrumentation-exceptions.ja.md)。
