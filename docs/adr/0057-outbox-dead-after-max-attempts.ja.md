...
# ADR-0057: MaxAttempts = 10 到達でメッセージをデッド状態にする（手動リプレイまで終端）

English canonical: [0057-outbox-dead-after-max-attempts.md](0057-outbox-dead-after-max-attempts.md)
...
- 関連 ADR: [ADR-0054](0054-at-least-once-outbox-poll.ja.md)、[ADR-0058](0058-outbox-retention-gc.ja.md)。
