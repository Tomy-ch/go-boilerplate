...
[ADR-0076](0076-vendor-neutral-otlp-export.md). Vendor enrichment belongs in the
Collector pipeline.
...
- Complements: [ADR-0076](0076-vendor-neutral-otlp-export.md) (vendor-neutral export).
- Parent gating: [ADR-0075](0075-config-driven-observability-gating.md).
