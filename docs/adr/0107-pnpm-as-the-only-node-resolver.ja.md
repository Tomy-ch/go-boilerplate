...
# ADR-0107: Node パッケージはすべて pnpm で解決し、npm を使わない
...
クールダウン**（[ADR-0090 (malicious-package-detection-via-cooldown)](0090-malicious-package-detection-via-cooldown.ja.md)）
