...
# ADR-0034: シリアライゼーション競合時はトランザクションをリトライする。呼び出し元は冪等性を保証しなければならない

English canonical: [0034-transaction-retry-idempotent-callers.md](0034-transaction-retry-idempotent-callers.md)
