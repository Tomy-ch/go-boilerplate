...
# ADR-0036: Use UUIDv7 (time-ordered) identifiers for all entity primary keys
...
- Related: [ADR-0026](0026-sqlc-type-safe-sql.md) (sqlc type overrides are the mechanism
