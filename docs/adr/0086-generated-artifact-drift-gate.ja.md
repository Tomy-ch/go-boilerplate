...
# ADR-0086: 生成成果物ドリフトゲートとリリースブランチ集約型自動生成ボット

English canonical: [0086-generated-artifact-drift-gate.md](0086-generated-artifact-drift-gate.md)
...
- 関連: [ADR-0025](0025-sqlc-type-safe-sql.ja.md) — DB 成果物生成のソースである sqlc。
