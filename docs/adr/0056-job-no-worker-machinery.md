...
# ADR-0056: Jobs deliberately have no broker, circuit breaker, drain, or health machinery
...
([ADR-0038](0038-broker-agnostic-worker-scaffold.md)) provides a rich operational layer:
...
- Contrast with [ADR-0038](0038-broker-agnostic-worker-scaffold.md) (worker: broker seam,
