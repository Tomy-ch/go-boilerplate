...
| --- | --- | --- |
| Web / API | `labstack/echo/v5` | HTTP web framework (see [ADR-0022 (echo-http-framework)](../adr/0022-echo-http-framework.md)) |
...
| Errors / utils | `google/uuid` | UUID generation (UUIDv7, see [ADR-0037 (uuidv7-identifiers)](../adr/0037-uuidv7-identifiers.md)) |
...
| DI / logging / CLI | `go.uber.org/fx` | Dependency injection container (see [ADR-0040 (uber-fx-di)](../adr/0040-uber-fx-di.md)) |
