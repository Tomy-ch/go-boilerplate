...
| Errors / utils | `google/uuid` | UUID generation (UUIDv7, see [ADR-0030](../adr/0030-uuidv7-identifiers.md)) |
...
| DI / logging / CLI | `go.uber.org/fx` | Dependency injection container (see [ADR-0031](../adr/0031-uber-fx-di.md)) |
