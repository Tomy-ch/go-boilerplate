...
| 領域 | ライブラリ | 責務 |
| --- | --- | --- |
| Web / API | `labstack/echo/v5` | HTTP web フレームワーク（[ADR-0022](../adr/0022-echo-http-framework.ja.md) 参照） |
...
| Errors / utils | `google/uuid` | UUID 生成（UUIDv7、[ADR-0037](../adr/0037-uuidv7-identifiers.ja.md) 参照） |
...
| DI / logging / CLI | `go.uber.org/fx` | DI コンテナ（[ADR-0040](../adr/0040-uber-fx-di.ja.md) 参照） |
