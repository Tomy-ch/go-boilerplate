...
同じフローを手で実行することも可能で、禁止もされていません。それは互換経路です。手順はここに書かれたとおりですが、本来それを駆動するスキルは手元に無く、同等の手動ツールも並行して保守されません。[ADR-0007 (agents-md-operational-contract)](adr/0007-agents-md-operational-contract.md) を参照してください。
