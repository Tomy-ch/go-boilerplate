...
> **Architecture Decision Records (ADR)**. See **[`docs/design/adr/`](design/adr/README.md)**
...
- Start at the [ADR log](design/adr/README.md) for the full list and ordering.
...
the immutable records. See [ADR-0000](design/adr/0000-record-architecture-decisions.md).
