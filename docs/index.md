...
|[design/adr/](design/adr/README.md)|Architecture Decision Records — background of technology selection and design decisions|
...
```mermaid
flowchart TB
    A["architecture.md"] --> B["development-flow.md"] --> C["rules.md"] --> D["design/adr/"]
```
...
```mermaid
flowchart TB
    A["architecture.md"] --> B["rules.md"] --> C["development-flow.md"] --> D["design/adr/"]
```
