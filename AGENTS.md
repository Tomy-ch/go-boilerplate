...
3. After updating an existing PR branch, push the verified commits to its upstream automatically. This applies only to a normal `git push`; the prohibitions on rebase, squash, and force-push remain in effect.
