...
4. Existing usecase packages (e.g., `internal/usecase/user/user_usecase.go`) are a **secondary** reference only — observe but never silently follow if they diverge from the README's reference implementation; README wins.
