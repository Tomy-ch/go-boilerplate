...
|`StreamTicket.yaml`|Security|Query stream-ticket scheme for the SSE endpoint (ADR-0074 (query-ticket-stream-authentication))|
...
|Security schemes|Descriptive name|`BasicAuth.yaml`, `BearerAuth.yaml`, `StreamTicket.yaml`|
