...
|`StreamTicket.yaml`|Security|SSE endpoint 用の query stream ticket scheme（ADR-0074 (query-ticket-stream-authentication)）|
...
|セキュリティスキーム|説明的な名前|`BasicAuth.yaml`, `BearerAuth.yaml`, `StreamTicket.yaml`|
