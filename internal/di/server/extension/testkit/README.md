...
It centralizes the repetitive setup of building a throwaway `fx` app and asserting what a module provides into a fx group, so each extension's `module_graph_test.go` stays small and consistent.
