...
var (
	...
	expectedObservabilityTargetStatusCodes    = []int{400, 401, 403, 404, 405, 409, 410, 422, 429, 500, 501, 503}
	expectedObservabilityTargetStatusCodesStr = "400,401,403,404,405,409,410,422,429,500,501,503"
