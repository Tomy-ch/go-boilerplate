...
//
//	mockgen -source=connection.go -destination=mock/mock_connection.go.gen.go -package=mock_driver
//
...
func (mr *MockDBTXMockRecorder) Exec(ctx, sql any, args ...any) *gomock.Call {
