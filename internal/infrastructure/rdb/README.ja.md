...
[ADR-0032 (commandservice-atomicity-criterion)](../../../docs/adr/0032-commandservice-atomicity-criterion.md)）。最初の実装は
`command_service/purchase`（在庫減算 + 購入 / 明細 INSERT。
[ADR-0034 (ordered-pessimistic-row-locks)](../../../docs/adr/0034-ordered-pessimistic-row-locks.md) 参照）です。
...
[ADR-0030 (lightweight-cqrs)](../../../docs/adr/0030-lightweight-cqrs.md) § Derivation を参照。
