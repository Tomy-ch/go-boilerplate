...
[ADR-0033 (commandservice-atomicity-criterion)](../../../docs/adr/0033-commandservice-atomicity-criterion.md)）。最初の実装は
`command_service/purchase`（在庫減算 + 購入 / 明細 INSERT。
[ADR-0035 (ordered-pessimistic-row-locks)](../../../docs/adr/0035-ordered-pessimistic-row-locks.md) 参照）です。
...
[ADR-0031 (lightweight-cqrs)](../../../docs/adr/0031-lightweight-cqrs.md) § Derivation を参照。
