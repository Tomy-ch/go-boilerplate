...
//
//	mockgen -source=httpclient.go -destination=mock/mock_httpclient.go.gen.go -package=mock_httpclient
//
...
import (
	context "context"
	httpclient "go-boilerplate/internal/infrastructure/httpclient"
	reflect "reflect"
...
func (m *MockClient) Do(ctx context.Context, req *httpclient.Request) (*httpclient.Response, error) {
	m.ctrl.T.Helper()
