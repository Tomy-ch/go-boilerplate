...
伴います。
[ADR-0053 (broker-sdk-isolation-measured-as-coupling)](../../../../docs/adr/0053-broker-sdk-isolation-measured-as-coupling.md) を参照。
...
本リポジトリがボイラープレートとして頒布されている間、この条件はサンプル削除を実行して結果を突き合わせる形で検査されます。詳細は [`docs/get-started/boilerplate-only-conventions.md`](../../../../docs/get-started/boilerplate-only-conventions.md) に記録しています。 <!-- boilerplate-only:line -->
...
[`infrastructure/awsclient`](../../awsclient/README.md) を通すため、`AccessKeyID` /
