//go:generate oapi-codegen --include-tags=internal/types/error-response --package=gen --generate=types -o ./gen/types.gen.go /app/openapi/openapi.gen.yaml

// Package errorresponse は、echoでのエラーレスポンスを生成するためのユーティリティを提供します。
package errorresponse

import "boilerplate-go/internal/controller/handler/error/response/gen"
