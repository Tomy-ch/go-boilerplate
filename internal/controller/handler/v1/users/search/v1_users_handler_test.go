...
import (
	...
	gen "boilerplate-go/internal/controller/handler/v1/users/search/gen"
	"boilerplate-go/internal/observability"
	"boilerplate-go/internal/usecase/tools/paging"
	usecase_search "boilerplate-go/internal/usecase/user/search"
	mock_query "boilerplate-go/internal/usecase/user/search/mock"
