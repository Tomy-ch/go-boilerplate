...
//go:generate oapi-codegen --include-tags=v1/users/search --package=gen --generate=echo5-server,strict-server -o ./gen/server.gen.go /app/openapi/openapi.gen.yaml
