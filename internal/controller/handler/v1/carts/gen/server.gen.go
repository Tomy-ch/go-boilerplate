...
func (w *ServerInterfaceWrapper) GetCartsMe(ctx *echo.Context) error {
	var err error

	// Parameter object where we will unmarshal all parameters from the context
	var params GetCartsMeParams
	...
	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.GetCartsMe(ctx, params)
	return err
}
...
type GetCartsMeResponseObject interface {
	VisitGetCartsMeResponse(w http.ResponseWriter) error
}

type GetCartsMe200JSONResponse CartResponse

func (response GetCartsMe200JSONResponse) VisitGetCartsMeResponse(w http.ResponseWriter) error {
...
type GetCartsMe400JSONResponse struct{ BadRequest400JSONResponse }

func (response GetCartsMe400JSONResponse) VisitGetCartsMeResponse(w http.ResponseWriter) error {
...
type GetCartsMe401JSONResponse struct{ Unauthorized401JSONResponse }

func (response GetCartsMe401JSONResponse) VisitGetCartsMeResponse(w http.ResponseWriter) error {
...
type GetCartsMe405JSONResponse struct {
	MethodNotAllowed405JSONResponse
}

func (response GetCartsMe405JSONResponse) VisitGetCartsMeResponse(w http.ResponseWriter) error {
...
type GetCartsMe500JSONResponse struct {
	InternalServerError500JSONResponse
}

func (response GetCartsMe500JSONResponse) VisitGetCartsMeResponse(w http.ResponseWriter) error {
...
type GetCartsMe503JSONResponse struct {
	ServiceUnavailable503JSONResponse
}

func (response GetCartsMe503JSONResponse) VisitGetCartsMeResponse(w http.ResponseWriter) error {
...
func (sh *strictHandler) GetCartsMe(ctx *echo.Context, params GetCartsMeParams) error {
	var request GetCartsMeRequestObject

	request.Params = params

	handler := func(ctx *echo.Context, request interface{}) (interface{}, error) {
		return sh.ssi.GetCartsMe(ctx.Request().Context(), request.(GetCartsMeRequestObject))
	}
	for _, middleware := range sh.middlewares {
		handler = middleware(handler, "GetCartsMe")
	}
	...
	if err != nil {
		return err
	} else if validResponse, ok := response.(GetCartsMeResponseObject); ok {
		return validResponse.VisitGetCartsMeResponse(ctx.Response())
	} else if response != nil {
		return fmt.Errorf("unexpected response type: %T", response)
	}
	return nil
