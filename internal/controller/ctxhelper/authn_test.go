...
func TestWithAuthn(t *testing.T) {
	...
	t.Run("正常系_スロットを仕込むとSetAuthnが成功する", func(t *testing.T) {
		t.Parallel()
...
func TestSetAuthn(t *testing.T) {
	...
	t.Run("正常系_スロットがあれば書き込めGetAuthnで読める", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("異常系_スロット未仕込みなら書き込めずfalseを返す", func(t *testing.T) {
		t.Parallel()
...
func TestGetAuthn(t *testing.T) {
	...
	t.Run("異常系_スロット未仕込みならokはfalse", func(t *testing.T) {
		t.Parallel()
		_, ok := GetAuthn(context.Background())
		assert.False(t, ok)
	})

	t.Run("異常系_スロットはあるが未設定ならokはfalse", func(t *testing.T) {
		t.Parallel()
		ctx := WithAuthn(context.Background())
		_, ok := GetAuthn(ctx)
		assert.False(t, ok)
