...
[ADR-0049 (error-details-opt-in-gate)](../../../../docs/adr/0049-error-details-opt-in-gate.md) を参照。

## エラーコードとHTTPステータスの対応

### apperror → HTTP マッピング

HTTP ステータス列は [`internal/apperror/README.md`](../../../apperror/README.md) の対応表が所有するセンチネル分類を写したものです。エラーコード列は本層独自の追加です。
