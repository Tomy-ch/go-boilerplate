...
- **`Meta` never carries an HTTP status.** The status is resolved solely from the sentinel classification; to change the status, change the sentinel. This keeps the decision of [ADR-0046 (apperror-protocol-agnostic-errors)](../../docs/adr/0046-apperror-protocol-agnostic-errors.md) intact (see [ADR-0047 (error-metadata-code-message-details)](../../docs/adr/0047-error-metadata-code-message-details.md)).
