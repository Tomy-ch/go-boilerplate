...
- A domain package must **not** import another aggregate (enforced by depguard: `internal/domain/`
  ...
  Rationale: [ADR-0036](../../docs/adr/0036-domain-lexicon.md).
...
branches of [ADR-0031](../../docs/adr/0031-commandservice-atomicity-criterion.md) § Decision
procedure:
...
- **A guard that must not go stale** (branch 2). An operation reads another aggregate to decide
  ...
  ([ADR-0033](../../docs/adr/0033-ordered-pessimistic-row-locks.md)). The other aggregate is
...
conditions derived from domain invariants ([ADR-0029](../../docs/adr/0029-lightweight-cqrs.md)).
...
> ([ADR-0044](../../docs/adr/0044-apperror-protocol-agnostic-errors.md)); a composed `isSatisfiedBy`
