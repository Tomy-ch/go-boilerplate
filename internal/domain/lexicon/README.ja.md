...
[ADR-0038 (domain-lexicon)](../../../docs/adr/0038-domain-lexicon.md) を参照。
...
- `money` — `Price` 値オブジェクト（非負の価格スケール十進数。最小単位変換を所有）。
  正確な十進の器は `pkg/decimal`（[ADR-0037 (two-scale-quantity-model)](../../../docs/adr/0037-two-scale-quantity-model.md)）。
<!-- sample-api:end -->
