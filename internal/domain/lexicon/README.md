...
lives here — see [ADR-0038 (domain-lexicon)](../../../docs/adr/0038-domain-lexicon.md).
...
- `money` — `Price` value object (non-negative price-scale decimal; owns minor-unit conversion).
  The exact decimal container is `pkg/decimal` ([ADR-0037 (two-scale-quantity-model)](../../../docs/adr/0037-two-scale-quantity-model.md)).
<!-- sample-api:end -->
