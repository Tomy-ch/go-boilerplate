...
type Repository interface {
	...
	FindAll(ctx context.Context, limit, offset int) (Entities, error)
	// FindByKeyword は、キーワード検索でユーザーの情報を取得します。
	FindByKeyword(ctx context.Context, keywords []string, active *bool, limit, offset int) (Entities, error)
