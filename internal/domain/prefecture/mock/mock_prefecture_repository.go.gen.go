...
//
//	mockgen -source=prefecture_repository.go -destination=mock/mock_prefecture_repository.go.gen.go -package=mock_prefecture
//
...
func (m *MockRepository) FindAll(ctx context.Context) (prefecture.Prefectures, error) {
	m.ctrl.T.Helper()
