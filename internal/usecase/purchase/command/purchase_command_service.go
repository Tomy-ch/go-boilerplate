...
// Package command は、購入の書き込み操作（CommandService）のインターフェースを定義します（ADR-0030 (lightweight-cqrs)）。
...
// 動かす判断は docs/adr/0030-lightweight-cqrs.md § Command Service の更新を伴います。
package command
...
// ADR-0032 (commandservice-atomicity-criterion) の Eligibility / Derivation を参照。
