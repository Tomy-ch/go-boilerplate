//go:generate mockgen -source=$GOFILE -destination=mock/mock_gc.gen.go -package=mock_$GOPACKAGE
package idempotency
...
// SweepExpired は、失効行をバッチ削除します。1 バッチ＝1 DELETE で long lock を避け、0 件になるまで反復します。
