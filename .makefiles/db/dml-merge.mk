...
.PHONY: merge-dml-commandq ## コマンドクエリ用DMLのマージ
...
.PHONY: merge-dml-ci-commandq ## コマンドクエリ用DMLのマージ（CI用）
...
merge-dml-commandq:
	make merge-dml-core type="command_query" work-dir="/app"
merge-dml-core:
...
merge-dml-ci:
	...
	make merge-dml-ci-commandq work-dir=$(work-dir)
merge-dml-ci-repo:
...
merge-dml-ci-commandq:
	make merge-dml-ci-core type="command_query" work-dir=$(work-dir)
merge-dml-ci-core:
