...
- `docker/**/README.md` (automatically rewritten by `make sync-versions`)
...
- `docker/README.md` — `golang:X.Y.Z-alpine` table cells
- `docker/server/README.md` — same
- `docker/tools/README.md` — same
