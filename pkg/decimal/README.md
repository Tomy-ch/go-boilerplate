...
It carries **no** business semantics — currency, non-negativity, and minor-unit choice live in the domain layer's value objects (see [`internal/domain/lexicon/README.md`](../../internal/domain/lexicon/README.md)). This package is pure decimal arithmetic, rounding, scaling, and the DB / wire boundary.
