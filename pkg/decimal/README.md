...
業務意味論は一切持ちません。通貨・非負・最小単位の選択はドメイン層の値オブジェクト（[`internal/domain/lexicon/README.md`](../../internal/domain/lexicon/README.md)）が所有します。本パッケージは純粋な十進算術・丸め・スケール変換と DB / ワイヤ境界だけを担います。
